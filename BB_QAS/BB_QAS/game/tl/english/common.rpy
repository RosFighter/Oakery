...
translate english strings:
    ...
    old "Changes will take effect the next tm this program is run."
    new "Changes will take effect the next tm this program is run."
    ...
    old "Attempts a roll back to a prior tm, allowing you to save or choose a different choice."
    new "Attempts a roll back to a prior tm, allowing you to save or choose a different choice."
