...
default items = {
    "spider": Item(_("ПАУК"), _("Самое страшное существо на свете. С точки зрения Алисы, конечно. Нужно этим воспользоваться в подходящий момент!"), "interface items spider", None, have=True),
    ...
    "bathrobe": Item(_("ШЕЛКОВЫЙ ХАЛАТ"), _("Короткий, лёгкий, почти шёлковый халат высшего качества. Made in China."), "interface items bathrobe", _("Одежда"), 100, have=True, cells=2),
    "bikini": Item(_("КУПАЛЬНИК КРАСНЫЙ"), _("Купальник для тех, кто не стесняется своего тела. Скрывает только самые интимные участки. Всё остальное открыто для солнца и глаз окружающих."), "interface items bikini", _("Одежда"), 200, have=True, cells=2),
    "cigarettes": Item(_("СИГАРЕТЫ"), _("Пачка сигарет Lucky Strike. Для настоящих мужчин!"), "interface items cigarettes", _("Другое"), 10, have=True),
    "dress": Item(_("МАЛЕНЬКОЕ ЧЕРНОЕ ПЛАТЬЕ"), _("Отличный подарок для девушки, желающей произвести фурор на вечеринке или дискотеке."), "interface items dress-1", _("Одежда"), 200, have=True, cells=2),
    "erobook_1": Item(_("ЛЮБЯЩАЯ РУБИ"), _("Роман о запретной любви между секретаршей и её начальником, полный любви, страсти, эмоций и... мистики."), "interface items erobook-1", _("Книги"), have=True),
    "erobook_2": Item(_("ПРЕМЬЕР-МИНИСТР"), _("Новый эротический роман, входящий в Топ-10 лучших романов и новелл США!"), "interface items erobook-2", _("Книги"), have=True),
    "erobook_3": Item(_("БЫТЬ КУКЛОЙ"), _("В поместье Картера красивые девушки обучаются, чтобы стать идеальными жёнами для самых влиятельных людей этого мира."), "interface items erobook-3", _("Книги"), have=True),
    "erobook_4": Item(_("КНИГА ОРГАЗМОВ"), _("Что получится, если собрать самые горячие истории об оргазмах от 69 различных авторов?"), "interface items erobook-4", _("Книги"), have=True),
    "erobook_5": Item(_("ИСТОРИЯ О"), _("Это история о доминировании и подчинении. История об одной прекрасной девушке по имени О."), "interface items erobook-5", _("Книги"), have=True),
    "ladder": Item(_("Стремянка"), _("Небольшая стремянка, позволяющая достать то, для чего не хватает роста"), "interface items ladder", _("Другое"), have=True, cells=2),
    "manual": Item(_("WEB STANDARDS"), _("Книга рассказывает о способах создавать свои сайты, работающие на любых устройствах."), "interface items manual-1", _("Книги"), have=True),
    #"": Item(_(""), _(""), "", _(""), ),
    }
...
default talks = {
    ...
    "lisa_fd"   : TalkTheme("lisa", _("О школе..."), "about_school", "day==1 and tm>=\"16:00\" and talk_var[\"lisa_fd\"]==0"),
