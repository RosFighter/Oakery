...
default schedule_lisa = [
    Schedule((0, 1, 2, 3, 4, 5, 6), "0:0", "6:59", _("спит в нашей комнате (ночь)"), "house", 0, "lisa_sleep"),
    Schedule((0, 1, 2, 3, 4, 5, 6), "7:0", "7:59", _("принимает душ"), "house", 3, "lisa_shower"),
    Schedule((0, 1, 2, 3, 4, 5, 6), "8:0", "8:59", _("читает в нашей комнате"), "house", 0, "lisa_read"),
    Schedule((1, 2, 3, 4, 5), "10:0", "10:59", _("одевается в школу"), "house", 0, "lisa_dressed_school"),
    Schedule((6, ), "10:0", "10:59", _("одевается в магазин"), "house", 0, "lisa_dressed_shop"),
    Schedule((0, ), "10:0", "10:59", _("одевается за закрытыми дверями"), "house", 0, "lisa_dressed_somewhere"),
    Schedule((1, 2, 3, 4, 5), "11:0", "15:59", _("в школе")),
    Schedule((6, ), "11:0", "13:59", _("в магазине")),
    Schedule((0, ), "11:0", "14:59"),
    Schedule((6, ), "14:0", "14:59", _("читает в нашей комнате"), "house", 0, "lisa_read"),
    Schedule((0, 6), "15:0", "15:59", _("в бассейне"), "house", 6, "lisa_swim"),
    Schedule((1, 2, 3, 4, 5), "16:0", "16:59", _("в бассейне"), "house", 6, "lisa_swim"),
    Schedule((0, 6), "16:0", "16:59", _("загорает"), "house", 6, "lisa_sun"),
    Schedule((1, 2, 3, 4, 5), "17:0", "18:59", _("загорает"), "house", 6, "lisa_sun"),
    Schedule((6, ), "17:0", "17:59", _("учит уроки"), "house", 0, "lisa_homework"),
    Schedule((0, ), "17:0", "17:59", _("читает в нашей комнате"), "house", 0, "lisa_read"),
    Schedule((0, 6), "18:0", "18:59", _("читает в нашей комнате"), "house", 0, "lisa_read"),
    Schedule((0, 1, 2, 3, 4, 5, 6), "20:0", "20:59", _("моет посуду"), "house", 4, "lisa_dishes"),
    Schedule((0, 1, 2, 3, 4, 5, 6), "21:0", "21:59", _("лежит с телефоном в нашей комнате"), "house", 0, "lisa_phone"),
    Schedule((0, 1, 2, 3, 4, 5, 6), "22:0", "22:59", _("принимает ванну"), "house", 3, "lisa_bath"),
    Schedule((1, 2, 3, 4, 5), "23:0", "23:59", _("учит уроки"), "house", 0, "lisa_homework"),
    Schedule((0, 6), "23:0", "23:59", _("лежит с телефоном в нашей комнате"), "house", 0, "lisa_phone"),
]
...
default ask_money = False     # просил карманные деньги у мамы
