...
label InitStuff: # стартовая инициация предметов
    python:
        ...
        items = {
            ...
            # "pajamas"   : Item(_("Пижамка"), _("Уютная пижамка из легкой и приятной ткани. Подходит как для сна, так и для повседневного ношения"), "pajamas", 0, 100),
            # "nightie"   : Item(_("Ночночная рубашка"), _("Кружевная сорочка и трусики для сладких снов"), "nightie", 0, 100),
            # "cosmatic1" : Item(_("Набор косметики"), _("Небольшой набор косметики для повседневного использования."), "cosmatics1", 5, 100),
            # "cosmatic2" : Item(_("Набор косметики"), _("Небольшой набор косметики для повседневного использования."), "cosmatics2", 5, 100),
            # "cosmatic3" : Item(_("Набор косметики"), _("Небольшой набор косметики для повседневного использования."), "cosmatics3", 5, 100),
            # "": Item(_(""), _(""), "", , ),
            # "": Item(_(""), _(""), "", , ),
            }
...
label InitPoss: # Возможности
    ...
    $ possibility["sg"] = Poss(_("Школьница"), [
                ...
                PossStage("interface poss lessons ep01", _("Хоть я и обещал Лизе помогать с уроками, делать я этого не стал. После очередной двойки она подошла ко мне и упрашивала о помощи. Я согласился, но с условием, что она будет спать только в футболке и трусах. И думаю, что мне удастся её ещё на что-нибудь раскрутить..."), _("Правда она обиднелась на меня немного, но это я переживу, подарю ей что-нибудь и она оттает...")),
