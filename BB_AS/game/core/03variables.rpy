...
label AddKira:
    ...
    $ chars['kira'] = Profile('kira', _("Кира"), _("Киры"), _("Кире"), _("Киру"), _("Кирой"), _("Кире"), _("Тётя Кира, мамина младшая сестра. Конечно, у неё и раньше не были замечены какие-либо комплексы, но сейчас она стала такой... такой..."), 'Kira', 165)
    $ kira = chars['kira']
