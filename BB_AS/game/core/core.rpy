    ...
    if current_ver == "v0.01.TechDemo":
        ...
        if current_ver < '0.03.1.006':
            ...
            $ items.update({
                ...
                "ferrero-m": Item(_("Конфеты \"Ferrero Rocher\""), _("Сочетание цельного фундука и восхитительного сливочно-орехового крема в хрустящей вафельной оболочке подарит вам неповторимые вкусовые ощущения."), "ferrero-1", 2, 40),
