...
label set_ann_schedule:
    ...
    $ ann.add_schedule(
        ...
        Schedule((0, 1, 2, 3, 4, 5, 6), '9:0', '9:59', 'breakfast', "семейный завтрак", 'house', 5, 'breakfast', enabletalk=False, glow=105),
        Schedule((1, 2, 3, 4, 5), '10:0', '10:39', 'dressed', "одевается на работу", 'house', 2, 'ann_dressed_work', enabletalk=False, glow=115),
        ...
        Schedule((1, 2, 3, 4, 5), '10:40', '18:59', 'at_work', "на работе"),
        Schedule((6, ), '11:0', '13:59', 'in_shop', "в магазине"),
...
label set_eric_schedule:
    ...
    $ eric.add_schedule(
        Schedule((4,), '0:00', '5:59', 'sleep2', 'спит с Анной', 'house', 2, 'eric_ann_sleep', variable="not flags.eric_banished", enabletalk=False, glow=110),
        Schedule((4,), '0:00', '5:59', 'None', variable="flags.eric_banished"),
...
label set_lisa_schedule:
    ...
    $ lisa.add_schedule(
        ...
        Schedule((1, ), '20:00', '20:29', 'dishes', "моет посуду", 'house', 4, 'lisa_dishes', variable="'eric' in chars and flags.lisa_sexed > 6 and any([lisa.dcv.intrusion.stage > 3, eric.daily.sweets, flags.eric_wallet])", talklabel='lisa_dishes_closer'),
        Schedule((1, ), '20:00', '20:29', 'practice', 'практика с Эриком', 'house', 0, 'lisa_eric_sex_ed_practice', variable="'eric' in chars and all([flags.lisa_sexed > 6, lisa.dcv.intrusion.stage==3, not flags.eric_wallet, not eric.daily.sweets])", enabletalk=False, glow=150),
