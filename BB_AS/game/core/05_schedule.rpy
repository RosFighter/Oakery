...
label alice_can_blog_in_underwear:
    $ alice.add_schedule(
        Schedule((1, 4), '20:0', '21:59', 'blog', "блог в нижнем белье", 'house', 1, 'alice_blog_lingerie', variable="poss['blog'].stn>4 and alice.dcv.feature.done", enabletalk=False, glow=150),
        Schedule((1, 4), '20:0', '21:59', 'blog', "в своей комнате", 'house', 1, 'alice_rest_evening', variable="not(poss['blog'].stn>4 and alice.dcv.feature.done)", talklabel='alice_evening_closer', glow=110),
