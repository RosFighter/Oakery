...
translate english strings:
    ...
    new "This is Lisa, my younger sister. Cute and fan. She's still at high school. Despite the occasional argument we are quite close. If something happens, Lisa always runs to me for support."
    ...
    new "This is Alice, my older sister.  In any incomprehensible situation hits on slap (in the best case). She recently graduated high school and, just like me, is looking for a job. She spends all day on her laptop blogging. As is common with bitchy older sisters, she thinks I'm a idiot and we don't really get along."
    ...
    new "Anna, my mom. She has been raising us with two sisters for several years. She works in the office some company. She earns enough to survive, but rent, food, clothing, and other various expenses eat up most of her salary."
    ...
    new "Always looking to find adventures on her ass."
    ...
    new "dressing behind closed doors"
    ...
    new "lying with the phone in our room"

    # game/core/03variables.rpy:46
    old "принимает ванну"
    new "take a bath"

    # game/core/03variables.rpy:71
    old "спит"
    new "sleeps"

    # game/core/03variables.rpy:71
    old "спит с Эриком"
    new "sleeping with Eric"
    ...
    # game/core/03variables.rpy:71
    old "смотрит ТВ с Эриком"
    new "watching TV with Eric"

    # game/core/03variables.rpy:71
    old "в своей комнате трахается с Эриком"
    new "in his room fucking with Eric"

    # game/core/03variables.rpy:99
    old "куда-то одевается"
    new "somewhere dresses"

    # game/core/03variables.rpy:130
    old "ПОСМОТРЕТЬ\nФИЛЬМ"
    new "WATCH\nTHE MOVIE"
    ...
    new "Swimsuit for those who are not shy about their bodies. Hides only the most intimate areas. Everything else is open to the sun and the eyes."
    ...
    new "I've found an empty box of a hidden cam. It's probably installed somewhere in the house. I should try to find it, what if someone has been watching us all this time?"
    ...
    new "I've found the hidden cam in the living room. It's mounted in the wall, I can't pull it out without damaging it. Therefore, it can not be pulled out without damaging. It's not connected to anything, maybe I should look up ways to fix that, it could be useful..."
    ...
    new "Here's an idea: I could earn some money by streaming live feed from the hidden cam.  Too bad I don't really know how to set everything up. Maybe I should look it up on the web?"
    ...
    new "Finally, I have my own streaming website! Now I need to increase my audience to earn more money. And for that I need to advertise my website somewhere, which will cost money. Also, audience will grow when something exciting happens on the stream."

    # game/core/03variables.rpy:316
    old "{i}{b}Внимание:{/b} Пока это всё, что можно сделать для данной «возможности» в текущей версии игры.{/i}"
    new "{i}{b}Attention:{/b} You've reached the end of this opportunity in a current version of the game.{/i}"
    ...
    new "Looks like Lisa doesn't know anything about male physiology. She was so surprised by my morning wood, maybe she hasn't even seen porn. Maybe I should give her some sex ed. I'll start by talking to her."
    ...
    new "I've found a book, but the name is vague and I don't want to waste my time on reading it. I should look it up on the web."
    ...
    new "I told Lisa to forget about Alex and she followed my advice. She's very upset, but maybe it's for the best? Maybe now she'll focus her attention on someone close and safe?"

    # game/core/03variables.rpy:316
    old "Я убедил Лизу, что нужно бороться за своё счастье. Осталось только разработать план и достичь поставленной цели!"
    new "I convinced Lisa she should fight for her happiness. Now I just have to came up with a plan and reach this goal!"
    ...
    new "After searching the web I learned that the most popular blogs have female hosts, and their popularity directly correlates with the size of their breasts and how revealing their outfits are. I can't really do anything with Alice's cup size, but her outfits... Maybe I should talk to her?"
    ...
    new "I gave Alice a cute lingerie set. She loved it. She even tried it on in front of me! I didn't get to see much, but the experience was very exciting anyway... And the best part is, she gave me a hint I could buy her something even sexier!"
    ...
    new "My new gift didn't quite had the effect I was hoping for. She said she's not going to wear a topless body for a blog and instead she'll wear it for someone, but refused to give me the details.  So many secrets..."
    ...
    new "Oh, yeah, she also told me she was approached by some advertiser.  They'll send her lingerie and then they'll pay for wearing it!  She doesn't need me anymore, though..."
    ...
    new "I noticed Lisa always wearing same one-piece swimsuit. How is she supposed to tan in that? She agrees, but she doesn't have anything else to wear, everything got lost in the moving process.  Maybe I can help her out somehow?"
    ...
    new "I couldn't buy Lisa the swimsuit that she wanted before Eric. I think their relationship improved. Too bad I couldn't give her that stupid swimsuit so Lisa would be grateful to me."

    # game/core/03variables.rpy:363
