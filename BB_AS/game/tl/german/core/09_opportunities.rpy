...
translate german strings:
    ...
    new "Ich fand eine leere Schachtel, die eine versteckte Kamera enthielt. Sie ist wahrscheinlich irgendwo im Haus installiert. Ich sollte versuchen, sie zu finden, was, wenn uns jemand die ganze Zeit beobachtet hat?"

    # game/core/09_opportunities.rpy:4
    old "Вероятнее всего, скрытая камера будет охватывать самую людную комнату внутри дома..."
    new "Am besten sollte die versteckte Kamera den am stärksten frequentierten Raum im Haus überwachen..."
    ...
    new "Ich habe die versteckte Kamera im Wohnzimmer gefunden. Sie ist in der Wand montiert, ich kann sie nicht herausholen, ohne sie zu beschädigen. Sie ist mit nichts verbunden, vielleicht sollte ich nach Möglichkeiten suchen, das zu beheben, es könnte nützlich sein..."

    # game/core/09_opportunities.rpy:4
    old "Информацию можно поискать с помощью ноутбука..."
    new "Die Inhalte können mit einem Laptop abgerufen werden..."
    ...
    new "Hier ist eine Idee: Ich könnte etwas Geld verdienen, indem ich den Live-Feed von der versteckten Kamera streame. Zu schade, dass ich nicht wirklich weiß, wie ich alles einrichten kann. Vielleicht sollte ich im Internet nachsehen?"

    # game/core/09_opportunities.rpy:4
    old "Иногда, специализированные книги куда лучше, чем то, что пишут в интернете! Это как раз такой случай..."
    new "Manchmal sind Fachbücher viel besser als das, was im Internet steht! Dies ist genau so ein Fall..."
    ...
    new "Die Hauptsache ist, die nötige Menge an Geld aufzubringen, der Rest ist nicht der Rede wert..."
    ...
    new "Ich brauche regelmäßig Geld für Werbung auf der Website, um schneller Geld für neue Kameras zu verdienen oder alternativ könnte ich versuchen, etwas von Alice, Mom oder Eric zu bekommen..."
    ...
    new "Großartig! Jetzt habe ich in jedem Raum Kameras! Die Kosten waren hoch, aber sie werden sich auf jeden Fall auszahlen, denn es gibt so viele schöne Mädchen in diesem Haus, die in regelmäßigen Abständen ihre Reize zeigen... Obwohl, es würde nicht schaden, eine weitere Kamera im Garten anzubringen, denn die Mädchen sind nicht nur zum Sonnenbaden, sondern auch zum Schwimmen dort. Um das Bild zu vervollständigen, wird mein Publikum definitiv die nassen Mädchen bewundern wollen! Auch die Kameraüberwachung im Bad ist zu gering, wenn auch recht interessant. Soll ich eine weitere Kamera installieren? Das muss noch getestet werden..."

    # game/core/09_opportunities.rpy:4
    old "Лучше начать с поиска хорошего обзора ванной комнаты..."
    new "Am besten ist es, wenn man sich zunächst einen guten Überblick über das Bad verschafft..."

    # game/core/09_opportunities.rpy:4
    old "Вечер - это самое лучшее время, чтобы попробовать подсмотреть за кем-нибудь в ванной комнате и не попасться..."
    new "Der Abend ist die beste Zeit, um zu versuchen, jemanden im Badezimmer zu beobachten und ich sollte dabei auch nicht erwischt werden..."

    # game/core/09_opportunities.rpy:4
    old "Стоит понаблюдать, чем обычно все занимаются у зеркала в ванной комнате..."
    new "Es lohnt sich zu beobachten, was ein jeder normalerweise vor dem Badezimmerspiegel tut..."

    # game/core/09_opportunities.rpy:4
    old "Не забыть установить вторую камеру во дворе и в ванной комнате"
    new "Nicht vergessen, eine zweite Kamera im Hof und im Badezimmer zu installieren"
    ...
    new "Nun, ich denke, neun Kameras werden mehr als genug sein, um gutes Geld zu verdienen! Jetzt muss ich nur noch dafür sorgen, dass meine Zuschauer auf jedem von ihnen etwas zu sehen bekommen..."

    # game/core/09_opportunities.rpy:4
    old "Особые книги"
    new "Besondere Bücher"
    ...
    new "Alice liest gerade einige geheimnisvolle Bücher, über die sie nicht sprechen möchte. Sie sehen nicht wie Pornos aus, was könnte das wohl sein? Ich sollte dem nachgehen."

    # game/core/09_opportunities.rpy:4
    old "Стоит поискать книгу в комнате Алисы..."
    new "Ich sollte das Buch in Alices Zimmer suchen..."
    ...
    new "Ich habe ein Buch gefunden, aber der Name ist seltsam, und ich möchte meine Zeit nicht damit verschwenden, es zu lesen. Ich sollte es im Internet suchen."

    # game/core/09_opportunities.rpy:4
    old "Всё просто! До ноутбука дойти не проблема..."
    new "Das ist leichter als gedacht! Es ist kein Problem, an den Laptop zu kommen..."
    ...
    new "Wow, ich hatte fast Recht! Es ist kein Porno, aber es ist definitiv Erotik, und es ist auch nicht die sanfte Art! Ich schätze, Alice mag Liebesgeschichten mit einem erotischen Touch. Vielleicht sollte ich ihr welche schenken und ihre Reaktion sehen."

    # game/core/09_opportunities.rpy:4
    old "Наверняка удастся найти похожие книги в интернет-магазине. Были бы деньги..."
    new "Wahrscheinlich findet man ähnliche Bücher auch in Onlineshops. Wenn ich das Geld hätte..."
    ...
    new "Ihrer Reaktion nach zu urteilen, gefiel ihr mein Geschenk. Ich sollte ab und zu im E-Book-Store nach Neuerscheinungen Ausschau halten."
    ...
    new "Mir ist aufgefallen, dass Lisa immer den gleichen einteiligen Badeanzug trägt. Wie soll sie sich darin bräunen? Sie ist einverstanden, aber sie hat nichts anderes zum Anziehen, alles ging verloren, als wir umzogen. Vielleicht kann ich ihr irgendwie helfen?"

    # game/core/09_opportunities.rpy:4
    old "Стоит подождать, вдруг проблема разрешится сама собой..."
    new "Es lohnt sich, abzuwarten, ob sich das Problem von selbst löst..."
    ...
    new "Beim Frühstück hat Lisa Mom gegenüber angedeutet, dass sie beim Einkaufen einen Bikini kaufen soll, der nicht die Hälfte ihres Körpers verdeckt und in dem Sie sich sonnen kann..."
    ...
    new "Es stellt sich heraus, dass bei der letzten Einkaufstour vergessen wurde, Lisa den gewünschten Bikini zu kaufen. Jetzt muss Sie sich bis nächstes Wochenende gedulden, wenn Eric wieder mit allen einkaufen geht. Aber dann hat Eric selbst versprochen, ihr diesen Bikini zu schenken. Vielleicht sollte ich ihm zuvorkommen."
    ...
    new "Ich habe es geschafft, etwas Geld zu sparen und den Bikini zu kaufen, den Lisa so gerne haben wollte. Jetzt ist das Wichtigste, ihn für sie zu kaufen, bevor Eric es tut..."

    # game/core/09_opportunities.rpy:4
    old "Лучше торопиться и со всех ног бежать к Лизе..."
    new "Jetzt sollte ich mich beeilen und so schnell wie möglich zu Lisa gehen..."
    ...
    new "Ich kann es nicht glauben! Ich habe auf einen Bikini für Lisa gespart, und Eric kommt mir immer noch zuvor. Natürlich tut er das. Er hat mehr Geld als ich. Es scheint, dass sich ihre Beziehung verbessert hat."
    ...
    new "Gut, dass ich es geschafft habe, Lisa einen Bikini zu kaufen und ihn ihr zu geben, bevor Eric es getan hat! Ich glaube, Lisa liebt mich! Und jetzt bekommt Eric einen Korb mit seinen Geschenken, weil ich ihr schon das besorgt habe, was sich meine kleine Schwester wünscht!"
    ...
    new "Ich habe zwar den Bikini gekauft, aber ich konnte ihn ihr nicht geben... Eric ist mir zuvorgekommen! Wenn ich den verdammten Bikini bekommen hätte, wäre Lisa mir sehr dankbarer gewesen. Was soll ich jetzt mit einem Bikini anfangen?"
    ...
    new "Alice bettelt Mom, ihr ein Abendkleid zu kaufen, das sie in Nachtclubs anziehen kann. Sie lehnt regelmäßig ab, bis Eric ihr vorschlägt, ihr das Kleid beim nächsten Einkauf zu schenken. Ich muss mich beeilen, wenn ich das verhindern will!"
    ...
    new "Ich habe es geschafft, eine ordentliche Summe an Geld zu sparen und ein Kleid für Alice zu kaufen. Jetzt muss ich es ihr bringen, bevor es jemand anderes tut..."

    # game/core/09_opportunities.rpy:4
    old "Лучше торопиться и со всех ног бежать к Алисе..."
    new "Jetzt sollte ich mich beeilen und so schnell wie möglich zu Alice gehen..."
    ...
    new "Das bedeutet Unglück! Ich hatte lange auf ein schönes kurzes Kleid für Alice gespart und es sogar gekauft, aber Eric kam mir zuvor... Und das Schlimmste war, dass er genau die gleiche gekauft hat, aber es ihr zuerst gegeben hat. Jetzt habe ich ein nutzloses Kleid..."
    ...
    new "Um mehr darüber herauszufinden, was Alice außerhalb des Hauses macht, sollte ich meine Beziehung zu Lisa verbessern. Die Schwestern müssen alle möglichen pikanten Geheimnisse übereinander wissen..."
    ...
    new "Das bedeutet Unglück! Ich habe auf ein schönes kurzes Kleid für Alice gespart, aber Eric kam mir zuvor... Das wundert mich nicht. Er hat viel Geld. Er kann sich solche Geschenke leisten... Alice scheint ihn jetzt viel mehr zu mögen..."
    ...
    new "Lisa hat mir im Vertrauen etwas Interessantes erzählt. Es stellt sich heraus, dass Alice keinen Alkohol verträgt. Oder vielmehr: Ein Tropfen Alkohol verwandelt sie! Deshalb lässt sie sich auch nicht auf alkoholischen Getränken ein. Aber vielleicht fällt mir ja noch etwas ein?"

    # game/core/09_opportunities.rpy:4
    old "В магазине наверняка найдётся что-то, что мне поможет..."
    new "Ich bin sicher, es gibt etwas im Shop, das mir hilft..."
    ...
    new "Nun, ich habe mir eine Schachtel Schoko-Likör-Pralinen besorgt. Sie sollten so dezent sein, dass die Schwester keinen Alkohol bemerkt. Ich frage mich, ob das reichen würde, damit sie sich... verändern kann."

    # game/core/09_opportunities.rpy:4
    old "Проверить, действительно ли Алиса теряет голову от алкоголя, лучше прямо перед тем, как она отправится в клуб..."
    new "Um zu sehen, ob Alice wirklich den Verstand vom Alkohol verliert, ist es am besten, kurz bevor sie in den Club geht, zu kontrollieren..."
    ...
    new "Alles hat gut geklappt. Und ganz... unerwartet. Ich kann niemandem davon erzählen. Alice hat wohl ihre Hemmungen verloren und hat sich im Club betrunken. Hoffen wir, dass sie sich an nichts mehr erinnert, sonst bin ich erledigt..."

    # game/core/09_opportunities.rpy:4
    old "Интересно, если я не буду вести себя как озабоченный и скажу что-нибудь приятное, Алиса будет реагировать иначе..."
    new "Ich frage mich, wenn ich mich nicht so notgeil verhalte und etwas Nettes sage, wird Alice dann anders reagieren..."
    ...
    new "Ich fand es besonders toll, wie sehr sich Alice für ihr zickiges Verhalten mir gegenüber geschämt hat! Bei all den Süßigkeiten brauchte es nur ein Kompliment, damit Alice anfing, mich mit ihren nackten und fantastischen Brüsten zu reizen... Ich frage mich, ob man sie zu mehr überreden kann."
    ...
    new "Wenn Ich Alice das Tragen von Höschen ausrede, wird sie vielleicht auch keine im Club tragen. Und wenn ja, trägt sie sie vielleicht auch nicht nach dem Club..."

    # game/core/09_opportunities.rpy:4
    old "Чтобы добиться большего с Алисой в ванной комнате, мне стоит помогать ей с её блогом. Возможно, это нас сблизит..."
    new "Um es mit Alice im Bad besser zu haben, sollte ich ihr bei ihrem Blog helfen. Vielleicht bringt uns das näher zusammen..."
    ...
    new "Alice' sanfte Hände auf meinem Schwanz zu spüren, ist unheimlich geil! Ich will, dass sie es noch besser macht als so... Und da sie, unter Alkoholeinfluss stehend, keine Scheu hat, mir einen runterzuholen, was passiert, wenn ich sie mit meinen Küssen beeindrucke?"

    # game/core/09_opportunities.rpy:4
    old "Чтобы было, чем впечатлять, нужно хорошенько поучиться поцелуям..."
    new "Um beindrucken zu können, muss man lernen, wie man küsst..."
    ...
    new "Ich war mitten bei einem Kuss. Aber die Begeisterung für das Küssen allein reicht nicht aus, ich muss noch näher an sie herankommen, damit sie gar nicht auf die Idee kommt, mich zu stoppen, wenn ich anfange, sie während dieser Küsse ausgiebig zu streicheln!"
    ...
    new "Mit Alice im Bad zu spielen ist schon viel interessanter... Ich wünschte nur, sie könnte sich daran erinnern, was sie tut, nur ein kleines bisschen. Nun, in der Zwischenzeit habe ich alles, was ich brauche, um meine sexuelle Erfahrung mit Alice zu verfeinern. Ich muss nur daran denken, ihr noch ein Likörbonbon zu geben, wenn sie aus dem Club zurückkomme. Ob ich sie vor dem Spiegel oder in der Badewanne erwische, hängt davon ab, wie viel Zeit ich mit Tante Kira verbringe."
    ...
    new "Es stellte sich heraus, dass Alice raucht. Und sie versucht es zu tun, wenn niemand zu Hause ist. Das kann man verwenden... Es Mom zu sagen, kommt nicht in Frage, sonst würde Alice mich nicht in diesem Haus wohnen lassen! Aber man könnte Alice eine Falle stellen, damit meine Mum herausfindet... Und vielleicht würde das alles die Sache mit Alice besser machen? Ich habe mir überlegt, dass ich, wenn ich sie nicht an Mom verrate, sehen sollte, wie Alice reagieren würde."

    # game/core/09_opportunities.rpy:4
    old "Стоит немного подождать и мама сама что-нибудь заметит..."
    new "Es ist nur eine Frage der Zeit, bis Mom etwas merkt..."
    ...
    new "Mom hat zwar Zigarettenrauch gerochen, aber ich habe Alice nicht verraten. Mein Schwesterherz schien es zu schätzen. Ich meine, was hält sie davon ab, es so einzurichten, dass Mom es herausfindet, nicht von mir? Ich habe damit nichts zu tun. Am besten, man versucht, meine Schwester dazu zu bringen, etwas zu tun... Ich denke, sie wird mit vielem einverstanden sein, solange sie nicht vor allen Leuten den Arsch versohlt bekommt. Im Rahmen der Möglichkeiten, natürlich."

    # game/core/09_opportunities.rpy:4
    old "Нужно поймать Алису, когда она курит..."
    new "Man muss Alice beim Rauchen erwischen..."
    ...
    new "Es ist nicht so einfach, wie ich es mir vorgestellt habe! Alice ist zuversichtlich, dass sie ihre schlechte Angewohnheit vor Mom geheim halten kann. Offenbar muss ich Alices Erinnerung daran auffrischen, wie hart Moom dem Schuldigen den Arsch versohlt. Und dass ich jetzt für sie erinstehen kann!"

    # game/core/09_opportunities.rpy:4
    old "Лучше подложить сигареты в комнату Алисы на видное место прямо перед приходом мамы с работы..."
    new "Besser ist es, die Zigaretten an einer auffälligen Stelle in Alices Zimmer zu platzieren, kurz bevor Mom von der Arbeit nach Hause kommt..."
    ...
    new "Alices Arsch wurde also von Moom's strenger Hand verhauen! Jetzt ist ihr Geheimnis gelüftet und sie wird Mom nicht mehr so leicht täuschen... Außer natürlich, ich helfe ihr dabei. Alles, was bleibt, ist Alice zu überzeugen, dass ich ein guter Verbündeter sein kann... Aber nicht umsonst."
    ...
    new "Nun, es ist vollbracht. Jetzt ist Alice bereit, meine kleinen, aber pikanten Launen zu erfüllen. Es ist nicht schwer für sie, und es ist gut für mich. Oh, es wird jetzt eine Menge interessanter Situationen mit Alice geben..."
    ...
    new "Alice hat mir von ihrem Blog und dem \"Mangel an Kleidung\"-Problem erzählt. Jetzt hat sie nichts vorzuweisen, nichts, was sie im Blog anziehen kann, und sie hat ein gebrochenes Herz. Sie bittet verzweifelt um jede Art von Hilfe, sogar von mir! Vielleicht sollte ich im Internet nach Lösungen suchen?"
    ...
    new "Durch die Suche nach Informationen im Internet, was Alice tun könnte, konnte ich etwas herausfinden. Die beliebtesten Blogs waren die, bei denen die Verfasser Mädchen waren. Außerdem gilt: Je freizügiger die Outfits und je größer die Brüste, desto beliebter sind die Shows. An den Brüsten kann man natürlich nichts ändern, aber an den Outfits..."

    # game/core/09_opportunities.rpy:4
    old "Может быть, поговорить с ней об этом?"
    new "Vielleicht mit ihr darüber reden?"
    ...
    new "Ich diskutierte meine Schlussfolgerungen mit Alice und schlug vor, dass sie nicht nur für Cremes und Kosmetika werben sollte, sondern zum Beispiel auch für Dessous. Aber sie wird noch keine Show abziehen. Zumindest nicht wissentlich. Ich frage mich, was eine gut platzierte, versteckte Kamera in ihrem Zimmer enthüllen könnte?"

    # game/core/09_opportunities.rpy:4
    old "Всему своё время..."
    new "Alles zu seiner Zeit..."

    # game/core/09_opportunities.rpy:4
    old "Нужно будет последить через скрытую камеру за тем, как Алиса ведёт блог..."
    new "Man sollte das Bloggen von Alice mit versteckter Kamera verfolgen..."
    ...
    new "Ich diskutierte meine Schlussfolgerungen mit Alice und schlug vor, dass sie nicht nur für Cremes und Kosmetika werben sollte, sondern zum Beispiel auch für Dessous. Auch wenn sie vielleicht nicht bereit ist, eine Show zu veranstalten, hat sie mir dank der versteckten Kamera in ihrem Zimmer trotzdem eine gegeben. Ich sollte es jetzt, nachdem wir dieses Gespräch geführt haben, noch einmal überprüfen..."
    ...
    new "Ich erinnerte Alice an die Idee, in ihrem Blog für Dessous zu werben, und überraschenderweise stimmte sie zu! Ich sollte etwas finden, das sie sexy anzieht. Etwas, das wirklich die Aufmerksamkeit der Leute erregen kann..."

    # game/core/09_opportunities.rpy:4
    old "Стоит подарить Алисе красивое нижнее бельё. Дело плёвое, если есть деньги..."
    new "Es lohnt sich, Alice ein paar schöne Dessous zu besorgen. Es ist ein Kinderspiel, wenn man das Geld hat..."
    ...
    new "Ich habe Alice ein süßes Set Dessous geschenkt. Es hat ihr sehr gut gefallen. Ich konnte nichts anderes als Alice schon in eben diesen Dessous zu beobachten, aber selbst das war aufregend... Was am interessantesten ist, sie hat angedeutet, dass ich nach etwas mehr sexyeres... suchen kann! Und übrigens, soll ich vorschlagen, dass sie ein Fotoshooting macht? Alice könnte definitiv ein paar Dessous-Aufnahmen für ihren Blog gebrauchen. Hauptsache, sie hat Ja gesagt!"

    # game/core/09_opportunities.rpy:4
    old "Купить для Алисы что-нибудь посексуальнее я только рад. Были бы деньги... Как на нижнее бельё, так и на фотоаппарат..."
    new "Wenn ich etwas Sexieres für Alice kaufe, mache ich das gerne. Wenn ich das Geld habe... Sowohl für Dessous als auch für eine Kamera..."

    # game/core/09_opportunities.rpy:4
    old "Купить для Алисы что-нибудь посексуальнее я только рад. Были бы деньги..."
    new "Wenn ich etwas Sexieres für Alice kaufe, mache ich das gerne. Wenn ich das Geld habe..."

    # game/core/09_opportunities.rpy:4
    old "Самый лучший момент для дарения, когда Алиса ведёт свой блог в нижнем белье..."
    new "Der beste Moment zum Schenken ist, wenn Alice in ihrer Unterwäsche bloggt..."
    ...
    new "Ich habe Alice ein süßes Set Dessous geschenkt. Es hat ihr wirklich gefallen. Sie hat es sogar vor mir anprobiert! Ich habe nicht viel gesehen, aber es war spannend... Am interessantesten war, dass sie andeutete, dass ich nach etwas mehr sexyeres... suchen kann! Und übrigens, vielleicht sollte ich sie bitten, ein Fotoshooting zu machen. Alice könnte definitiv ein paar Dessous-Aufnahmen für ihren Blog gebrauchen. Hauptsache, sie hat Ja gesagt!"
    ...
    new "Ich habe etwas Aufreizenderes für Alice ausgesucht, einen halbtransparenten Body. Er ist immer noch bescheiden, weil ich sonst riskiere, sie darin nicht zu sehen. Während ich ihn ihr präsentierte, gelang es mir auch, sie zu überreden, für mich zu posieren... Sie brauchte hochwertige Fotos für ihren Blog! \n\nEs ist nicht so, dass sie zu anzüglich waren. Auch wenn Alice und ich uns noch nicht so nahe stehen, habe ich das Gefühl, dass wir anfangen, eine gemeinsame Basis zu finden. Wir werden sehen, was als nächstes passiert..."
    ...
    new "Ich habe etwas Aufreizenderes für Alice ausgesucht, einen halbtransparenten Body. Er ist immer noch bescheiden, weil ich sonst riskiere, sie darin nicht zu sehen. Während ich ihn ihr präsentierte, gelang es mir auch, sie zu überreden, für mich zu posieren... Sie brauchte hochwertige Fotos für ihren Blog! \n\nDas Foto-Shooting war dank der Pralinen und des Alkohols interessant. Ich habe es geschafft, einige sehr heiße Bilder von Alice für meine Sammlung zu machen... Obwohl Alice und ich uns noch nicht so nahe stehen, habe ich das Gefühl, dass wir anfangen, eine gemeinsame Basis zu finden. Wir werden sehen, was als nächstes passiert..."
    ...
    new "Gerade als meine Beziehung zu Alice anfing, besser zu werden, kam Eric zu mir rüber und fragte, was meine große Schwester am Computer macht... \n\nIch habe ihm alles erzählt, was ich über ihren Blog wusste. Natürlich habe ich das, wir sind Freunde. Jetzt wird er ihr dabei helfen, und ich sollte ihr besser nicht in die Quere kommen... Oder besser noch, ich schaue, ob ich helfen kann."

    # game/core/09_opportunities.rpy:4
    old "Нужно приглядывать за этой парочкой, когда они вместе. Вдруг удастся подслушать что-то важное..."
    new "Man sollte ein Auge auf die beiden haben, wenn sie zusammen sind. Mal sehen, ob man etwas Wichtiges herausfinden kann..."
    ...
    new "Gerade als meine Beziehung zu Alice anfing, besser zu werden, kam Eric zu mir rüber und fragte, was meine große Schwester am Computer macht... \n\nIch beschloss, es ihm nicht leicht zu machen und sagte, dass ich nichts wüsste. Jetzt will Eric, dass ich nachforsche und ihm in ein paar Wochen berichte, was ich weiß..."
    ...
    new "Jetzt habe ich etwas mehr Zeit, um mich Alice zu nähern, bevor Eric anfängt, sie noch heftiger anzubaggern..."
    ...
    new "Gerade als meine Beziehung zu Alice anfing, besser zu werden, kam Eric zu mir rüber und fragte, was meine große Schwester am Computer macht... \n\nIch beschloss, meinen Krieg mit ihm zu beenden und erzählte ihm alles, was ich wusste. Jetzt wird er Alice mit ihrem Blog helfen, und ich sollte ihm besser nicht in die Quere kommen... Oder besser noch, ich schaue, ob ich helfen kann."
    ...
    new "Gerade als meine Beziehung zu Alice anfing, besser zu werden, kam Eric zu mir rüber und fragte, was meine große Schwester am Computer macht... \n\nIch habe absolut keine Lust, ihm dabei zu helfen, meine Schwester anzumachen, was ich ihm auch gesagt habe. Wir haben eine Fehde. Ich will nicht verletzt werden..."
    ...
    new "Während Mom mittwochs im Bad ist, hängt Eric in Alices Zimmer ab. Angeblich versucht er, ihr mit ihrem Blog zu helfen, aber es ist klar, dass er sie nur anstarren will, während sie Dessous trägt... und versuchen, in ihr Höschen zu kommen, wenn er die Chance dazu hat."
    ...
    new "Während Mom mittwochs im Bad ist, hängt Eric in Alices Zimmer ab. Angeblich versucht er, ihr mit ihrem Blog zu helfen, aber es ist klar, dass er sie nur anstarren will, während sie Dessous trägt... und versuchen, in ihr Höschen zu kommen, wenn er die Chance dazu hat.\n\nIch hatte auch das Glück, herauszufinden, dass Eric ihr einen neuen Spitzenbodysuit kaufen wollte! Schade nur, dass sie nicht von mir danach gefragt hat. Ich frage mich, wie Eric reagieren würde, wenn ich ihm zuvorkommen würde..."
    ...
    new "Wenn ich das machen will, muss ich mich beeilen, um ihr vor Samstag einen Body zu besorgen... Und ich muss ihn ihr geben, wenn Alice in einem Blog beschäftigt ist, dann kann sie sich vor mir umziehen!"

    # game/core/09_opportunities.rpy:4
    old "Что бы я там не хотел, теперь уже поздно! Мне остаётся только наблюдать..."
    new "Was ich auch will, jetzt ist es zu spät! Ich kann nur noch zusehen..."

    # game/core/09_opportunities.rpy:4
    old "Надо хоть подсмотреть, как это сексуальное боди смотрится на Алисе..."
    new "Ich will wenigstens sehen, wie der sexy Body an Alice aussieht..."
    ...
    new "Eric gab Alice den Spitzenbody, um den sie gebeten hatte. Es schien sie einander näher zu bringen, was er ja auch wollte, aber ich kam nicht dazu. Ich muss Eric bald loswerden, sonst nimmt er mir alles weg..."
    ...
    new "Eric gab Alice den Body, um den sie gebeten hatte. Es schien sie einander näher zu bringen, ganz nach seinem Plan..."
    ...
    new "Ich habe Eric geschlagen und Alice den Body zuerst gegeben! Sie zog ihn sogar vor mir an. Beim Anziehen verkrampfte ihr Bein, aber das gab mir einen guten Grund, ihre schönen Beine noch ein bisschen weiter zu massieren als vorher... Ich sollte versuchen, ihr danach eine Massage zu geben!"

    # game/core/09_opportunities.rpy:4
    old "Какова будет реакция Эрика? Скоро я это узнаю! Зато, с Алисой теперь можно вести себя поувереннее во многих моментах..."
    new "Wie wird Eric reagieren? Das werde ich gleich herausfinden! Aber ich könnte jetzt in vielerlei Hinsicht selbstbewusster mit Alice umgehen..."
    ...
    new "Eric war, gelinde gesagt, nicht begeistert, dass ich ihm zuvorkam, indem ich Alice einen Spitzenbody schenkte. Er warnte mich, dass wir keine Freunde mehr sein würden, wenn ich seine Pläne noch einmal durchkreuzte... Und zur Strafe hat er mir meinen ganzen \"Bonus\" weggenommen, den ich nun ausgleichen muss..."

    # game/core/09_opportunities.rpy:4
    old "Эрик оказался, мягко говоря, не в восторге от того, что я опередил его с дарением кружевного боди для Алисы.\n\nОн пригрозил, что у меня теперь будут большие проблемы! Как будто меня этим можно испугать..."
    new "Eric war nicht glücklich darüber, dass ich ihm zuvorkam, als er Alice den Body gab. \n\nJetzt hat er mir gedroht, als ob ich in Schwierigkeiten wäre! Als ob mir das Angst einjagen würde..."
    ...
    new "Lisa schien überhaupt nichts über Jungs zu wissen. Vielleicht hatte sie noch nie einen Porno gesehen, da sie von einem normalen Morgenständer so überrascht war. Vielleicht sollte ich meine kleine Schwester erziehen. Aber wo soll ich da anfangen?"

    # game/core/09_opportunities.rpy:4
    old "Для начала, нужно поговорить об этом с Лизой..."
    new "Für den Anfang sollte ich mit Lisa darüber reden..."
    ...
    new "Ich habe mit Lisa gesprochen und es wurde klar, dass ich, um ihr etwas beizubringen, zuerst ihr Vertrauen gewinnen musste. Damit ich nicht als geiler Perverser angesehen werde und mein Ständer etwas Natürliches für Lisa wird... oder sogar interessant... Und das braucht Zeit. Sie soll sich erst daran gewöhnen."

    # game/core/09_opportunities.rpy:4
    old "Не стоит просыпаться раньше Лизы, иначе она не привыкнет к моему \"приподнятому\" состоянию..."
    new "Ich darf nicht vor Lisa aufwachen, sonst gewöhnt sie sich nicht an meinen \"Harten\"-Zustand..."
    ...
    new "Lisa hat wieder meine Morgenlatte gesehen. Diesmal hat sie Mom nicht gerufen, was gut ist. Ich habe das Gefühl, dass sie meinen Schwanz diesmal mit etwas anderem als Misstrauen angestarrt hat... Ich denke, wir sollten mit ihr darüber reden..."

    # game/core/09_opportunities.rpy:4
    old "Чем раньше поговорю с ней об этом, тем лучше..."
    new "Je eher ich mit ihr darüber rede, desto besser..."
    ...
    new "Die Neugierde überwältigte sie. Ich erwischte Lisa dabei, wie sie versuchte, mich zu berühren, weil sie dachte, ich würde schlafen. Ihrer Reaktion nach zu urteilen, war sie genauso überrascht wie ich. Mal sehen, was sie später dazu sagt..."
    ...
    new "Es scheint, dass Lisas Interesse für das andere Geschlecht und alles, was mit dem Erwachsenenleben zu tun hat, sprunghaft wächst. Ich bin mir nicht sicher, wie sehr meine Morgenlatte diese ganze Aufregung erregt hat, aber sie hat sich bereit erklärt, mir bei Fragen über Jungen und den ganzen Erwachsenen-Kram zuzuhören... Aber bevor Ich Sie unterrichten kann, sollten Sie vielleicht selbst etwas lernen? Das Wichtigste ist, nicht zu weit zu gehen..."
    ...
    new "Also fragte mich Lisa, was ich ihr beibringen würde, und sie brachte mich sofort in eine heikle Situation. Ich soll ihr beibringen, wie man küsst, aber was weiß ich schon! Ich muss sofort jemanden finden, der mir dabei hilft... vielleicht leichter gesagt als getan..."

    # game/core/09_opportunities.rpy:4
    old "Стоит поговорить об этом с Алисой и мамой. Сомневаюсь, что они мне чем-то помогут, но попытка - не пытка..."
    new "Ich sollte mit Alice und meiner Mutter darüber reden. Ich bezweifle, dass sie mir helfen werden, aber es ist einen Versuch wert..."
    ...
    new "Tante Kira ist eine ausgezeichnete Kuss-Lehrerin! Das war sehr cool! Aber ich habe noch einen langen Weg vor mir. Sie hat sich bereit erklärt, mich manchmal zu unterrichten, und das ist eine gute Sache. Also bin ich nicht so schlecht, oder Tante Kira wollte mich einfach nicht beleidigen. Wer weiß, vielleicht bringt sie mir auch noch etwas anderes bei?"
    ...
    new "Das war's, man kann sagen, ich habe die Grundlagen gemeistert und es war sehr heiß! Beim Küssen mit Tante Kira habe ich eine Menge sehr erregender und schöner Dinge berührt... Jetzt muss ich das Küssen mit ihr weiter üben und das Gelernte an Lisa weitergeben... Und es ist am besten, sie zu unterrichten, wenn sie am entspanntesten ist und in meinem Zimmer mit ihr. Nur muss sie noch überzeugt werden..."
    ...
    new "Es ist besser, dass Lisa gut gelaunt ist, sonst ist sie wahrscheinlich nicht bereit, mich zu küssen. Der perfekte Moment ist, wenn sie liest..."
    ...
    new "Ich habe mit Lisa darüber gesprochen, sie zu unterrichten. Sie stellte eine Reihe von Bedingungen, unter anderem, dass ich sie nicht anfassen darf, wenn sie es nicht will. Na, das ist doch schon mal was. Natürlich ist es schwer, nicht mit den Händen über ihren Körper zu gleiten, wenn ich sie küsse... Aber wenn ich ein guter Küsser bin, dann macht es ihr vielleicht nichts aus, wenn ich sie berühre. Und ich muss daran denken, Lisa bei guter Laune zu halten."
    ...
    new "Um Lisa mit meinen Küssen zu beeindrucken, ist es wichtig, dass ich die Kussstunden mit Tante Kira fortsetzen. Erfolgreiches Küssen mit Lisa: [lisa.flags.kiss_lesson] von 3"
    ...
    new "Ich schaffe es, Lisa mit meinen Kusskünsten zu beeindrucken! Es ist noch nicht wirklich Perfekt, aber sie liebt es! Immerhin ist Tante Kira eine großartige Lehrerin. Aber ich muss sowohl mit Kira als auch mit Lisa weiter üben. Übrigens, ich kann meine Kuss-Lektionen mit Lisa abwechslungsreich gestalten... Zum Beispiel könnte ich eine Möglichkeit nach einer erfolgreichen Massage ihrer Hände haben."
    ...
    new "Das Küssen von Lisa nach einer erfolgreichen Handmassage ist nur möglich, wenn an diesem Tag zuvor keine Kussstunden stattgefunden haben. Erfolgreiches Küssen mit Lisa: [lisa.flags.kiss_lesson] von 6"
    ...
    new "Lisa scheint sehr viel empfänglicher für Berührungen zu werden. Ich glaube, ich bin da an etwas dran. Ich übe besser noch etwas mit Kira."
    ...
    new "Mehr Übung darin, Kira zu küssen und Lisas Stimmung im Auge zu behalten. Erfolgreiche Küsse und dabei Lisa berühren: [lisa.flags.kiss_touch] von 3"
    ...
    new "Lisa gefällt es sehr, wie ich sie küsse. Sie hat sogar angedeutet, dass sie vielleicht daran interessiert ist, etwas Fortgeschritteneres zu lernen. Es ist an der Zeit, meine Theorie zu verfeinern. Vielleicht sollte ich ihr ein Anatomiebuch kaufen, damit sie mehr über die natürlichen Vorgänge, die zwischen Männern und Frauen ablaufen, lernen kann?"
    ...
    new "So etwas sollten ich in einem Online-Store suchen. Und wenn ich es gekauft haben, kann es nicht schaden, es selbst zu lesen. Obwohl es nicht notwendig ist, könnte ich es Lisa auch gleich geben..."
    ...
    new "Ich habe das Buch zu Ende gelesen! Ich habe eigentlich nichts Neues gelernt, aber ich habe etwas bemerkt, das Lisa und mir helfen könnte, uns näher zu kommen. In der Zwischenzeit sollte ich ihr das Buch geben."

    # game/core/09_opportunities.rpy:4
    old "Подарить можно в любое время, когда Лиза не особо занята..."
    new "Ich kann jederzeit ein Geschenk machen, wenn Lisa nicht zu beschäftigt ist..."
    ...
    new "Ich habe Lisa das Buch gegeben, das hoffentlich einige ihrer eher perversen Fragen beantworten wird. Ich werde sie fragen müssen, was sie denkt, nachdem ich ihr etwas Zeit zum Lesen gegeben habe."

    # game/core/09_opportunities.rpy:4
    old "Не факт, что Лиза прочитает её быстро. Нужно ждать..."
    new "Es ist nicht sicher, ob Lisa es so schnell lesen wird. Ich glaube, ich sollte warten..."
    ...
    new "Ich habe Lisa ein Buch gegeben, das viele Antworten auf ihre Fragen enthält. Ich hätte es gerne selbst gelesen, aber ich war zu faul.n\nIch sollte sie demnächst mal fragen, was sie davon hält..."
    ...
    new "Kaum hatte ich Lisa ein Buch über Sexualerziehung gegeben, tauchte Eric auf. Er und Mom werden ihre Sexualerziehung übernehmen! \n\nAls Gegenleistung für die Möglichkeit, diesen Prozess auszuspionieren, und einen unbestimmten Bonus habe ich zugestimmt, zu helfen. Wir sind ja schließlich \"Freunde\"."

    # game/core/09_opportunities.rpy:4
    old "Интересно, каким образом Эрик собирается втереться в доверие к Лизе? Так или иначе, скоро это станет ясно..."
    new "Ich frage mich, wie Eric Lisas Vertrauen gewinnen will? So oder so, es wird sich bald zeigen..."

    # game/core/09_opportunities.rpy:4
    old "Только я подарил Лизе книгу по сексуальному образованию, как тут же нарисовался Эрик. Он, видите ли, вместе с моей мамой, собирается взяться за её сексуальное воспитание! \n\nВ обмен на возможность подглядывать за этим процессом, я согласился его поддержать. Незачем мне враждовать с Эриком."
    new "Kaum hatte ich Lisa ein Buch über Sexualerziehung gegeben, tauchte Eric auf. Er und Mom werden ihre Sexualerziehung übernehmen! \n\nIm Austausch für die Möglichkeit, diesen Prozess auszuspionieren, habe ich zugestimmt, zu helfen. Ich muss Eric nicht verärgern."
    ...
    new "Kaum hatte ich Lisa ein Buch über Sexualerziehung gegeben, tauchte Eric auf. Er und Mom werden ihre Sexualerziehung übernehmen! \n\nObwohl er und ich \"Freunde\" sind, habe ich versucht, ihn davon zu überzeugen, dass es für Lisa noch ein bisschen früh ist, um zu lernen... Es hat nicht viel geholfen, aber Eric gab mir ein paar Wochen Zeit, um mit Lisa \"Bücher über Sexualerziehung\" zu lesen. Wenigstens habe ich mir etwas Zeit verschafft, die ich weise nutzen kann..."
    ...
    new "Kaum hatte ich Lisa ein Buch über Sexualerziehung gegeben, tauchte Eric auf. Er und Mom werden ihre Sexualerziehung übernehmen! \n\nNatürlich habe ich mich geweigert, ihm dabei zu helfen. Auf die Feindschaft! Ich glaube nicht, dass ich jetzt viel Zeit habe, ihn loszuwerden, also sollte ich lieber nach einem solchen Weg suchen..."
    ...
    new "Wie sich herausstellte, hatte Eric sonntags einen Nachhilfelehrer für Lisa bezahlt, um ihre Noten zu verbessern, aber eigentlich nur, um ihr Vertrauen zu gewinnen. Aber nicht jetzt, denn ich habe noch ein wenig Zeit, bevor Eric anfängt, sich bei Lisa einzumischen."

    # game/core/09_opportunities.rpy:4
    old "Пока у меня есть дополнительное время на то, чтобы больше сблизиться с Лизой, Эрик к ней не сунется..."
    new "Solange ich noch Zeit habe, Lisa näher zu kommen, wird Eric ihr nicht zu nahe kommen..."
    ...
    new "Anscheinend ist Lisa Hals über Kopf in einen Klassenkameraden namens Alex verliebt. Wie sie mir erzählt, hat er eine Freundin namens Olivia, das hübscheste Mädchen der Schule. Lisa wartet auf meine Hilfe in Form von Ratschlägen, was sie als nächstes tun soll.\n\n Und das ist eine gute Frage! Auf der einen Seite möchte ich ihr mit praktischen Ratschlägen helfen, auf der anderen Seite möchte ich meine kleine Schwester nicht in die Hände von Alex geben. Ich muss eine Weile darüber nachdenken."

    # game/core/09_opportunities.rpy:4
    old "Да, и похоже о своём мальчике Лиза разговаривает только, когда у неё хорошее настроение..."
    new "Ja, und es scheint, dass Lisa nur über Jungs spricht, wenn sie gut gelaunt ist..."
    ...
    new "Nachdem ich lange darüber nachgedacht hatte, welchen Rat ich Lisa wegen Alex geben sollte, entschied ich mich, schlau zu sein und ihr vorzuschlagen, sich mit Olivia anzufreunden. Auf diese Weise konnte Lisa von ihr erfahren, ob Alex wirklich so gut war, wie sie dachte. Ich bin sicher, er ist nicht perfekt... Vielleicht sogar viel schlimmer... Ich weiß nicht, wie lange es dauern wird, bis Lisa sich unauffällig mit Olivia anfreunden kann. Ich sollte wohl von Zeit zu Zeit nach ihrem Fortschritt fragen..."

    # game/core/09_opportunities.rpy:4
    old "Думаю, через 5-7 дней у Лизы можно будет что-нибудь узнать..."
    new "Ich denke, Ich könnte in 5-7 Tagen etwas von Lisa bekommen..."
    ...
    new "Lisa versucht herauszufinden, wie sie sich mit Olivia, der Freundin von Alex, anfreunden kann. Um dies zu erreichen, wird Lisa versuchen, sich mit jemandem anderen anzufreunden, der Olivia mag, um ihm mehr Informationen über dieses Mädchen zu entlocken... Ich werde eine Weile warten und sehen, was Lisa herausfindet."
    ...
    new "Lisa ist es gelungen, eine kuriose Eigenheit von Olivia herauszufinden: Sie trägt keine Unterwäsche! Natürlich ist es nicht besonders viel, aber es könnte ein gutes Thema für eine Unterhaltung sein... Und dann lernten sie sich kennen, und dann wurden sie Freunde..."
    ...
    new "Endlich hat etwas funktioniert! Lisa hat es geschafft, herauszufinden, dass Olivia keine Höschen trägt, weil sie aus einer Nudisten- oder Naturisten-Familie stammt, was auch immer. Und sie liebt auch Pools, aber aus irgendeinem Grund funktioniert das bei ihnen zu Hause nicht. Jetzt ist es nur noch eine Frage der Zeit... Für Lisa, um Olivia zu unserem Haus einzuladen, wo sie sich sonnen und schwimmen können. Und natürlich soziale Kontakte außerhalb der Schule, die sie meiner Meinung nach näher zusammenbringen werden..."
    ...
    new "Ich habe Olivia kennengelernt! Ja, die Realität hat meine Erwartungen sogar leicht übertroffen! Olivia ist völlig schamlos mit ihrer Nacktheit... Darauf habe ich entsprechend reagiert. Nun, das Wichtigste ist, dass ich einen bleibenden Eindruck hinterlassen habe..."
    ...
    new "Es würde nicht schaden, mit Olivia zu reden, während sie und Lisa ein Sonnenbad nehmen. Um zu wissen, was sie vorhat und wie es ihr und Lisa geht..."
    ...
    new "Ich habe es geschafft, ein kurzes Gespräch mit Olivia zu führen. Sie ist nicht so dumm, wie ich dachte. Sie ist lustig, fröhlich, scharfzüngig... Oh, das würde ich gerne mal ausprobieren... Aber ich wurde abgelenkt. Soweit ich weiß, ist ihre Beziehung zu Alex nicht perfekt. Die Frage ist nur, wessen Schuld es mehr ist, ihre oder seine? Ich denke, mit der Zeit werden Lisa und ich mehr über sie erfahren können. In der Zwischenzeit kann ich mindestens einmal in der Woche völlig unbeeindruckt Olivias nackte Brüste in unserem Hinterhof betrachten!"

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать общаться с Оливией, когда она бывает у нас в гостях по средам..."
    new "Ich muss mit Olivia in Kontakt bleiben, wenn sie uns mittwochs besucht..."
    ...
    new "Olivia und ich haben ein bisschen über Lisa geredet. Auch wenn es nicht sehr nett war, sind wir zu dem Schluss gekommen, dass wir an der sexuellen Selbstbestimmung meiner kleinen Schwester arbeiten müssen. Zumindest ein bisschen... Und Olivias Gesellschaft ist perfekt dafür. Sie ist ein ungehemmtes Mädchen, sehr aufgeschlossen in jeder Hinsicht. Und wie man so schön sagt: Man bekommt, was man bekommt, von dem, den man bekommt!"

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать общаться с Оливией, когда она бывает у нас в гостях. Теперь по вторникам и пятницам..."
    new "Ich muss mit Olivia in Kontakt bleiben, wenn sie zu Besuch kommt. Jetzt immer dienstags und freitags..."
    ...
    new "Olivia hat herausgefunden, dass am Freitagabend unser Haus so gut wie leer ist und Lisa und ich für eine Zeit lang alleine sind... Das ist eine tolle Gelegenheit für uns drei, eine gute Stunde vor unseren großen Fernseher im Wohnzimmer zu kuscheln! Und das Beste daran ist, ich habe keine Ahnung, was es sein wird. Aber was ich weiß, ist, dass es Spaß machen wird..."
    ...
    new "Ich denke, ich bin Lisa schon nahe genug gekommen, dass sie und Olivia nichts gegen meine Gesellschaft am Freitagabend haben würden. Darauf habe ich nur noch warten..."
    ...
    new "Olivia kam um Mitternacht, wie versprochen. Obwohl ich geahnt habe, was für einen Abend wir haben werden, habe ich mich trotzdem gefragt, ob ich so viel Glück haben werde... Und Olivia hat mich nicht enttäuscht! Sie hat sich sofort all ihrer Klamotten entledigt..."
    ...
    new "Nur wurden alle meine anderen Hoffnungen durch Lisas Abneigung, auf der gleichen Couch wie mein Ständer zu sitzen, zunichte gemacht! Es ist unglaublich frustrierend... Ich habe so tolle Mädels, die mitten in der Nacht auf unserer Couch sitzen und ich möchte bei ihnen sein! Es scheint so, als müsste etwas getan werden, damit mein geiler Blick für Lisa etwas ganz Normales und Natürliches wird. Solange sie sich für mich schämt, kann ich nicht zu ihnen auf die Couch..."
    ...
    new "Äh... Wie cool ist es, mit so schönen Mädels auf der gleichen Couch zu sitzen! Olivia ist völlig nackt... Ich bin völlig nackt... Lisa ist die Einzige, die noch schüchtern ist. Aber ich denke, mit der Zeit, wenn diese Zusammenkünfte zur Gewohnheit werden, wird sie sich daran gewöhnen und darüber hinaus wird sie selbst anfangen, sich auszuziehen! Es tut nicht weh, zu träumen. Die Hauptsache ist, sie nicht unter Druck zu setzen, sondern sie sich daran gewöhnen zu lassen... Es ist möglich, dass sie insgeheim wirklich das alles mag, was passiert!"

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать общаться с Оливией, когда она бывает у нас в гостях. По вторникам и пятницам..."
    new "Ich muss mit Olivia in Kontakt bleiben, wenn sie zu Besuch kommt. Dienstags und freitags..."
    ...
    new "Olivia hat mir einige ihrer Bedenken erzählt... Nachdem Alex von ihr erfahren hat, wie cool und teuer unser Haus ist, hat er sich sehr schnell umentschieden und angefangen, Lisa anzugraben. Klingt, als wäre Alex das Alphamännchen... Jetzt ist es wichtig, Lisa auf diese Tatsache aufmerksam zu machen. Ich denke, sie wird früher oder später zu mir kommen und mich um Rat fragen... Mehr als einmal."
    ...
    new "Lisa wird auf jeden Fall zu mir kommen und mich um Rat fragen. Ich muss nur bereit sein, ihr gute Ratschläge zu geben, damit sie die richtige Wahl treffen kann..."
    ...
    new "Und so endete es auch für Alex! Olivia hat ihn abserviert, und Lisa war enttäuscht von ihm. Aber wenn es nicht meine Hinweise gewesen wären, hätte Lisa etwas Dummes getan und dieser erste nächtliche Besuch von Olivia wäre vielleicht ihr letzter gewesen... Aber eine einzige Sache hat Lisa aus Spaß gemacht - sie hat ihr T-Shirt direkt vor meinen Augen ausgezogen! Das ist eine sehr schöne Kleinigkeit! Allerdings deutete sie an, dass dies ein Einzelfall bleiben könnte, daher ist es besser, alles zu tun, damit meine Schwester meine Aufmerksamkeit spürt..."
    ...
    new "Wenn ich meine kleine Schwester weiterhin ab und zu ohne Oberteil sehen will, muss ich versuchen, sie vor den Strafen von Mom zu schützen und zumindest ein bisschen bei den Hausaufgaben, der Handmassage und dem Abwasch helfen..."
    ...
    new "Jetzt habe ich diese beiden süßen Hintern zur Verfügung... Ich kann mir nicht helfen, aber ich frage mich... Olivia war nicht besonders angetan von Alex, aber eine Trennung ist eine Trennung und sie braucht offensichtlich Zeit, um sich zu erholen. Wer weiß, vielleicht klappt es ja mit ihr. Und damit Lisa ihre nackten Brüste öfter zeigen kann, braucht sie ein bisschen mehr Zuwendung... Das ist immer so und im Rahmen der Möglichkeiten. Und man kann dafür sorgen, dass sie vor den Strafen von Mom geschützt wird und auch dass ihr bei den Hausaufgaben geholfen wird. Man kann auch um ihre Hände kümmern, beim Abwasch helfen und sie massieren."
    ...
    new "Lisas Noten haben einen Sprung nach unten gemacht. Es sieht so aus, als ob die neue Schule ein höheres Bildungsniveau erfordert. Das ist eine gute Gelegenheit, mein Wissen zu zeigen und meiner kleinen Schwester zu helfen... Oder ihre Noten zu sabotieren und zu sehen, wie Mom sie bestrafen wird. Oder vielleicht etwas als Gegenleistung für meine Hilfe zu verlangen? Aber zuerst muss ich mit Lisa sprechen und sehen, was sie über die Situation denkt."
    ...
    new "Ich habe mit Lisa über den Unterricht gesprochen und angedeutet, dass sich meine Hilfe lohnen würde... einige Gefallen. Natürlich sagte sie nein. Aber das ist nur für den Moment. Bis zur ersten Bestrafung. Wenn sie einmal vor mir ihren hübschen Arsch versohlt bekommen hat, wird sich alles ändern! Aber damit das passiert, muss sie wieder eine Sechs bekommen..."

    # game/core/09_opportunities.rpy:4
    old "Нужно просто подождать, пока она получит двойку и её накажут. Посмотрим, что она скажет после этого..."
    new "Ich muss nur warten, bis sie eine Sechs bekommt und bestraft wird. Mal sehen, was sie danach sagt..."
    ...
    new "Ich habe mit Lisa gesprochen und ihr versprochen, dass ich ihr beim Unterricht helfen werde. Und es ist ohne Gegenleistung. Ich meine, umsonst. Natürlich ist das nicht sehr typisch für mich, aber es gibt jede Chance, eine Beziehung zu meiner Schwester aufzubauen und ihr Vertrauen zu gewinnen... Für den Anfang, mache ich ihre Hausaufgaben mindestens sechs Mal. Das sollte genug sein, damit sie anfängt, auf meine Hilfe zu hoffen und jedes Mal darauf zu warten."

    # game/core/09_opportunities.rpy:4
    old "Выполнено за Лизу домашних заданий: [lisa.flags.truehelp]"
    new "Für Lisa Hausaufgaben erledigt: [lisa.flags.truehelp]"
    ...
    new "Ich glaube, ich habe Lisa überzeugt, mir aus Angst vor Bestrafung zuzuhören. Jetzt schläft sie nur noch in T-Shirt und Höschen. Und das ist erst der Anfang! Jetzt kann ich unter dem Vorwand, ihr zu helfen, ihre Hausaufgaben schlecht machen, damit ich zusehen kann, wie sie bestraft wird... Wer weiss, vielleicht kann ich sogar noch weiter gehen?"
    ...
    new "Es ist einen Versuch wert, Lisa dazu zu bringen, etwas von dem Zeug zu machen, bevor ich ihr bei den Hausaufgaben helfe..."
    ...
    new "Ich helfe Lisa schon seit einer Weile mit ihren HAusaufgaben, und zwar kostenlos. Jetzt ist es an der Zeit, ihr zu zeigen, wie sehr sie meine Hilfe braucht und ihr nicht mehr zu helfen. Oder sogar einen Fehler bei ihren Hausaufgaben machen. Dann bekommt sie ganz schnell eine schlechte Note und wird von Mom bestraft. Nur dass ich dafür von Lisa viel härter angegangen werden könnte, als wenn ich einfach aufhöre, ihr zu helfen. Ich muss mich entscheiden..."
    ...
    new "Einfach aufhören zu helfen und darauf warten, dass Lisa eine Sechs bekommt oder Fehler bei ihren Hausaufgaben macht? Was ist besser..."
    ...
    new "Und so bat sie mich nach einer weiteren \"4\" und einer Bestrafung durch Mom um Hilfe. Ich stimmte zu, aber unter der Bedingung, dass sie nur in T-Shirt und Slip schlafen würde. Und ich denke, ich kann sie dazu bringen, noch mehr zu tun..."
    ...
    new "Ich dachte nicht, dass es funktionieren würde, aber ich konnte Lisa zu einem weiteren Anreiz überreden... Sie zeigte mir ihre süßen kleinen Brüste! Ich habe sie noch nie aus der Nähe gesehen. Sie sind fantastisch. Aber ja, ich muss Sie daran erinnern, dass dies aus einem bestimmten Grund geschieht und Ich ihr bei ihren Hausaufgaben helfen muss. Jetzt bin ich noch neugieriger, was würde sie noch tun, wenn ich ihr weiterhin helfe?"
    ...
    new "Es lohnt sich, Lisa dazu zu bringen, mir öfters ihre Brüste zu zeigen. Am leichtesten ist es, wenn sie sehr gut gelaunt ist..."
    ...
    new "Alice ist eine ziemliche Quasselstrippe! Ich erzähle Lisa, was für eine tolle Massage ich ihr gebe. Das ist gut, denn Lisa hat es so gewollt. Jetzt kann ich ihre schlanken Beine massieren, während sie ihre Hausaufgaben macht. Und ich kann natürlich bewundern, was unter ihrer Kleidung steckt. Wenn es ihr gefällt, wie ich ihre Füße massiere, will sie vielleicht auch etwas anderes massiert bekommen?"

    # game/core/09_opportunities.rpy:4
    old "Пусть Лиза поймёт, что я хорош в массаже ног. Нужно массировать её ножки почаще..."
    new "Lisa soll wissen, dass ich gut darin bin, Füße zu massieren. Ich sollte ihre Füße öfters massieren..."
    ...
    new "Lisa schienen meine Massagen langsam zu gefallen. Sie fragte sogar, ob ich auch ihre Hände massieren könnte. Ich weiß selbst sehr gut, wie müde meine Arme manchmal werden durch die Schule, und dienstags und freitags ist Lisa besonders müde. Deshalb ist es an diesen Tagen besser, sich zu beeilen und zu versuchen ihre Hände zu massieren bevor sie sich für die Hausaufgaben hinsetzt. Es ist möglich, dass Lisa, nachdem ich beim Massieren ihrer Hände Fortschritte gemacht hat, nichts dagegen hat, wenn ich etwas mehr massiere."

    # game/core/09_opportunities.rpy:4
    old "Нужно начать с покупки хотя бы одного урока массажа рук и уже только после этого переходить к практике..."
    new "Ich muss damit beginnen, mindestens eine Handmassage-Lektion zu absolvieren und erst danach zur Praxis überzugehen..."
    ...
    new "Je mehr Handmassage-Lektionen ich lernen kann, desto effektiver kann ich sie anwenden. Die beste Zeit zum Massieren ihrer Hände ist, wenn Lisa an ihrem Telefon ist..."
    ...
    new "Jetzt kann ich Lisas Füße genauso gut massieren wie ihre Hände. Mit ein wenig Übung wird alles gut funktionieren. Vielleicht will sie ja, wenn die Massage gut läuft, dass ich noch etwas anderes als ihre Füße massiere, z.B. ihre Schultern... Ich bin sicher, sie sind auch angespannt."
    ...
    new "Wenn ich eine Handmassage erfolgreich abschließen kann, und während ich bei den Hausaufgaben und den Füßen helfe, sollte ich versuchen, Lisa zu einer Schultermassage zu überreden..."
    ...
    new "Nicht umsonst habe ich angefangen, Lisas Hände zu massieren! Es stimmt, wenn sie die Fußmassage nicht mag, hat es keinen Sinn, bei ihr weiterzumachen. Selbst nachdem ich beides richtig gemacht hat, muss sie zu einer Schultermassage überredet werden. Hoffentlich wird es mit der Zeit einfacher, sie zu überzeugen, aber in der Zwischenzeit sollte ich weiter üben..."
    ...
    new "Wenn ich Lisa mit allem, was ich kann, genügend Aufmerksamkeit schenke, kann ich nach der Schultermassage versuchen, noch weiter zu gehen. Oder besser gesagt, tiefer..."
    ...
    new "Sieht so aus, als würde ich ziemlich gut in der Massage werden! Nun, es ist nicht nur das... Meine Beziehung zu Lisa wurde nicht nur eng, sondern stellenweise intim. Natürlich ist es noch in einer harmlosen Form, aber es fängt gerade erst an. Ich möchte über das Küssen mit meiner kleinen Schwester hinauskommen, aber es ist nicht so einfach."

    # game/core/09_opportunities.rpy:4
    old "Арахнофобия"
    new "Angst vor Spinnen"
    ...
    new "Sieht so aus, als hätte Alice schreckliche Angst vor Spinnen. Und das Klima hier ist sehr gut für diese Art von Insekten... Eines zu fangen und bei Alice abzuladen, sollte urkomisch sein! Wie würde ich jetzt eins bekommen?"
    ...
    new "Ich habe im Internet nachgeschaut, und es gibt eine lokale Art von Spinnen, die perfekt für mein Ziel wäre! Sie ist völlig harmlos und ziemlich groß. Sieht aus, als könnte ich versuchen, eine am Morgen zu fangen, wenn Spinnen ihre Netze auf Beute kontrollieren."
    ...
    new "Ich sollten Alice beim Duschen beobachten. Wenn die Atmosphäre stimmt, könnte ich eine Spinne auf sie ansetzen..."
    ...
    new "Es ist besser, die Spinne kurz vor dem Einschlafen von Alice zu platzieren. Sonst hat die Spinne viel länger Zeit zu entkommen..."
    ...
    new "Es ist besser, eine Spinne zu positionieren, wenn ich Alice eine Massage gebe. Wenn sie wirklich entspannt ist, wird sie viel mehr Angst haben..."
    ...
    new "Alice muss so entspannt wie möglich sein. Das ist es, was es braucht, um sich um ihren \"Arsch kümmern\" zu können..."

    # game/core/09_opportunities.rpy:4
    old "Хорошо бы нам с ней быть, как можно более раздетыми. Я в одних шортах, а Алиса без верха купальника..."
    new "Es wäre schön, wenn sie und ich so nackt wie möglich wären. Ich bin in Shorts und Alice trägt kein Oberteil..."
    ...
    new "Also, ich traf diesen Typen Eric, den Freund meiner Mutter. Ich kann weder etwas Gutes noch etwas Schlechtes über ihn sagen, aber ich mag ihn nicht sonderlich. Fast sofort stellte er mich vor die Wahl, mit ihm befreundet zu sein oder gegen ihn zu kämpfen. Nur warum sollte ich mit ihm befreundet sein wollen? Wozu soll das gut sein? Und zu kämpfen... Was könnte er mir antun? Jedenfalls gab er mir eine Woche Zeit, darüber nachzudenken. Nun, ich werde darüber nachdenken und entscheiden, was richtig ist..."

    # game/core/09_opportunities.rpy:4
    old "Буду думать. Что ещё остаётся..."
    new "Ich werde weiter nachdenken. Was bleibt sonst noch übrig..."
    ...
    new "Mit Erics Ankunft wurde es unerwartet schlimm für mich... Zuerst drohte er mir an, mich in ein Militärlager zu schicken. Er meinte, es wäre nötig, um einen Mann aus mir zu machen... Ich bin schon ein Mann! Ich pfeife auf das Lager...\n\nDanach hat er meine Mutter davon überzeugt, dass wir auf eine andere Art und Weise bestraft werden sollten. Ich meine, ich weiß nicht, was gut ist, aber es ist... Also, ab nächster Woche werden wir voreinander bestraft... nackt! Das ist so peinlich!\n\nIch meine, ich weiß, es würde Spaß machen, die Brüste meiner Schwestern zu sehen, aber ich könnte auch vor allen Leuten bestraft werden. Ich meine, das würde meine Autorität wirklich untergraben!\n\nErst diese blöde Militärlager-Idee, und jetzt das... Ich muss etwas dagegen Eric unternehmen!"
    ...
    new "Ich musste ernsthaft darüber nachdenken, ob ich wirklich mit Eric befreundet sein will oder nicht. Wenn wir Freunde geworden sind, habe ich vielleicht weniger Probleme, aber ich weiß nicht, ob ich dafür neue Schwirigkeiten haben werde. Wenn wir verfeindet sind, kann es gut sein, dass ich in einem Militärlager oder Schlimmerem lande. Als Mittelweg könnten wir ja Freunde sein, aber bei jeder sich ergebenden Gelegenheit sollte ich Intrigen gegen ihn schmieden..."
    ...
    new "Egal, wie sich meine Beziehung zu Eric entwickelt, ich sollte Dreck über ihn ausgraben. Es würde keinen Schaden anrichten. Früher oder später kommt er an meine beiden Schwestern ran, und dann erwische ich ihn bei irgendwas..."
    ...
    new "Also kam Tante Kira, Moms kleine Schwester, zu uns. Natürlich hatte sie vorher keine Komplikationen gesehen, aber jetzt ist sie so... Also... Und sie sah auch meinen Schwanz am ersten Tag! So peinlich. Aber Tante Kira zeigte sich auch in all ihrer Pracht, in einem Bikini wie diesem, wenn man das überhaupt als Bikini bezeichnen kann... Und solche Hinweise auf meinen Vater. War es wirklich so... ...kannten sie sich? Ich muss alles aus ihr herausholen, was ich kann."

    # game/core/09_opportunities.rpy:4
    old "Тётя Кира - женщина интересная. С ней стоит побольше общаться..."
    new "Tante Kira ist eine interessante Frau. Ich solltest mehr mit ihr reden..."
    ...
    new "Ich habe Tante Kira alles über Eric erzählt, einfach so. Sie schien an meinen Worten zu zweifeln, aber sie versprach, alles sorgfältig zu überprüfen. Vielleicht sogar mit Eric selbst reden... Es ist unwahrscheinlich, dass es bald passiert, denn Tante Kira verbringt viel Zeit auf der Arbeit und kommt erst sehr spät zurück. Also sollte ich in der Zwischenzeit beobachten, was Kira macht, bevor sie ins Bett geht..."

    # game/core/09_opportunities.rpy:4
    old "Тётя Кира вполне перед сном может посмотреть что-нибудь по ТВ. Неплохо было бы подсмотреть, что именно..."
    new "Tante Kira könnte auch etwas im Fernsehen schauen, bevor sie ins Bett geht. Es wäre schön zu wissen, was..."
    ...
    new "Tante Kira ist eine totale Schlampe! Sie schaut sich nachts Pornos an und denkt, dass es niemand sieht. Ich könnte versuchen, ihr Gesellschaft zu leisten... Ich hoffe, sie ist nicht so streng wie meine Mom. Wenn meine Überredungskünste nur gut genug wären..."
    ...
    new "Es lohnt sich, mindestens vier Kommunikationslektionen zu absolvieren, damit ich eine bessere Chance habe, Tante Kira zu überzeugen, gemeinsam Pornos zu schauen..."
    ...
    new "Das hat mir gefallen! Tante Kira und ich haben nicht nur Pornos geguckt, wir haben uns auch selbst gestreichelt. Ich weiß nicht einmal, was mich mehr anmachte: die Pornos auf dem großen Bildschirm oder Tante Kira in ihrem Nachthemd, die ihre Muschi durch ihr Höschen hindurch direkt vor mir streichelte. Obwohl, warum lügen... Das ist definitiv Tante Kira! Vielleicht macht sie so etwas auch in der Badewanne?"
    ...
    new "Es lohnt sich, Tante Kira beim Baden von der Stehleiter aus zu beobachten. Ich könnten etwas Interessantes sehen..."
    ...
    new "Gut, dass ich nicht gekniffen habe und zu Tante Kira ins Bad gegangen bin. Natürlich verstehe ich, dass sie nach dem, was wir beim Pornogucken gemacht hatten, nicht mit mir schimpfen würde, aber ich hatte trotzdem meine Bedenken. Was ich absolut nicht erwartet hatte, war, dass sie mich zu sich einlud und mich bat, ihr eine Fußmassage zu geben! Die Aussicht war natürlich hervorragend. Sie hat sogar leicht mit ihrem Fuß mit meinem Schwanz geflirtet, wie aus Versehen, aber sie und ich wissen, dass es kein Versehen war... Wir sollten das alles noch einmal machen. Und wenn ich in Zukunft einen Footjob von Tante Kira bekomme, sollte ich versuchen, nicht zu schnell abzuspritzen, um diesen Moment zu genießen."

    # game/core/09_opportunities.rpy:4
    old "Надеюсь, рано или поздно я привыкну к этим нежным ножкам, которыми она массирует мой член и не буду кончать так быстро..."
    new "Hoffentlich gewöhne ich mich früher oder später an diese sanften Beine, mit denen sie meinen Schwanz massiert, und ich komme nicht so schnell..."
    ...
    new "Es ist so schön, mit Tante Kira ein Bad zu nehmen! Sie streichelt ihre Muschi so leidenschaftlich, während sie meinen Schwanz massiert... Ich will mit meinen Fingern und meiner Zunge in sie eindringen, um sie noch lauter stöhnen zu lassen. Und ich denke, der beste Moment dafür ist, wenn sie mir beibringt, wie man küsst. Ich war schon sehr nah dran, aber jetzt, nach all dem Spaß in der Badewanne, ist es Zeit zu handeln..."
    ...
    new "Ich musste all meine Energie in meine Kuss-Stunden mit Tante Kira stecken und sie so erregen, dass sie mich ihre Muschi streicheln lässt! Und dann wird sie vielleicht etwas zurück geben..."
    ...
    new "Jetzt weiß ich, wie ich eine Tante mit meinen Fingern und meiner Zunge zum Orgasmus bringen kann! Und es ist unglaublich cool! Und es ist besonders cool, was sie im Gegenzug tut... Mir war vorher nicht klar, wie groß mein Schwanz ist. Tante Kira hatte Mühe, ihn in den Mund zu nehmen, und es war unglaublich befriedigend! Man könnte meinen, ich würde mich fragen, ob es das Richtige war, da sie meine Tante ist. Aber wen kümmert das schon, denn wir haben ja so viel Spaß. Wobei, hatte Kira bereits mit meiner Mutter über Eric gesprochen?"
    ...
    new "Übrigens, seit Kira und ich uns ziemlich nahe stehen, kann man mit ihr auch beim gemeinsamen Pornogucken und in der Badewanne turteln, und man kann sogar etwas im Pool ausprobieren!"

    # game/core/09_opportunities.rpy:4
    old "Неплохо бы поинтересоваться у тёти Киры, пока она загорает о том, поговорила ли она с мамой..."
    new "Es ist eine gute Idee, Tante Kira zu fragen, während sie ein Sonnenbad nimmt, ob sie mit Mom gesprochen hat..."
    ...
    new "Meine Tante macht Pornos! Lebe ich ernsthaft mit einem Pornostar zusammen? Kein Wunder, dass ich mich so zu ihr hingezogen fühle. Sie ist vollkommen sexsüchtig! Vielleicht wird es nicht so schwer, ihr näher zu kommen, wie ich dachte..."
    ...
    new "Kira hat mir angeboten, etwas Geld zu verdienen. Alles, was ich tun muss, ist sie zu fotografieren. Wie praktisch, dass ich bereits eine gute Kamera gekauft habe! Natürlich glaube ich nicht, dass sie mir so viel bezahlen wird, wie sie gekostet hat, aber es gibt eine Chance, dass ich etwas anderes für dieses Fotoshooting bekomme... Und wenn es ein Photoshooting für ein Porno-Portfolio sein soll, kann ich Kira auch ein Geschenk machen. Zum Beispiel ihr ein sexy Oberteil kaufen! Das wäre eine angenehme Sache für mich..."

    # game/core/09_opportunities.rpy:4
    old "Если есть деньги, то купить сорочку не трудно..."
    new "Wenn Ich das Geld habe, ist es nicht schwierig, ein Oberteil zu kaufen..."

    # game/core/09_opportunities.rpy:4
    old "Главное дождаться субботы, когда все уедут на шопинг..."
    new "Die Hauptsache ist, bis Samstag zu warten, wenn alle einkaufen sind..."
    ...
    new "Kira hat mir angeboten, etwas Geld zu verdienen. Alles, was ich tun muss, ist sie zu fotografieren. Aber dafür brauche ich eine Kamera. Natürlich glaube ich nicht, dass sie mir das bezahlen wird, was die Kamera kostet, aber die Chancen stehen gut, dass ich etwas anderes für das Fotoshooting bekomme... Und wenn es ein Porno-Portfolio-Fotoshooting werden soll, könnte ich Kira ein Geschenk besorgen. Zum Beispiel ihr ein sexy Oberteil kaufen! Das wäre eine gute Sache für mich..."

    # game/core/09_opportunities.rpy:4
    old "Если есть деньги, то купить фотоаппарат и сорочку не трудно..."
    new "Wenn Ich das Geld haben, ist es nicht sonderlich schwer, eine Kamera und ein Oberteil zu kaufen..."
    ...
    new "Das Fotoshooting verlief gut, aber ich habe nichts Neues gelernt. Zum Glück gab es ein paar interessante Momente, die es lohnend machten! Jetzt muss ich abwarten, wie die Bilder geworden sind. Hoffentlich kann ich dabei etwas Gutes herausholen..."

    # game/core/09_opportunities.rpy:4
    old "Стоит подождать хотя бы до понедельника и можно будет поинтересоваться у Киры, какой из меня фотограф..."
    new "Es lohnt sich, mindestens bis Montag zu warten und dann könnte ich Kira fragen, wie gut ich als Fotograf gewesen bin..."
    ...
    new "Also, die Bilder sind gut geworden und Kira und ich haben vereinbart, ein weiteres Fotoshooting zu machen, während niemand zu Hause ist. Aber man kann nicht sagen, wann es soweit ist... Ich frage mich, was Kira für das Shooting haben will?! Alles, was ich tun kann, ist warten... Und es gibt etwas, das die Wartezeit versüßt, vor allem, wenn ich das Oberteil habe. Tante Kira revanchierte sich gerne mit einem leidenschaftlichen Blowjob, als ich kaum noch Chancen besaß! Sehr schön!"

    # game/core/09_opportunities.rpy:4
    old "Подожду недельки полторы и поинтересуюсь, готова ли тётя Кира к новой фотосессии..."
    new "Ich warte anderthalb Wochen und schaue, ob Tante Kira für ein weiteres Fotoshooting bereit ist..."
    ...
    new "Und das war das zweite Foto-Shooting! Erstaunlich! Nicht nur, weil Kira ihre wilde Seite mit etwas BDSM zum Vorschein brachte, sondern weil wir tatsächlich Sex hatten! Mein erstes... Endlich... bin ich offiziell keine Jungfrau mehr! Ich meine... Inoffiziell... Ich kann niemandem wirklich erzählen, dass ich meine Tante gefickt habe. Davon abgesehen, sollte ich in Erics Nähe vorsichtig sein. Er scheint immer irgendwie neugierig zu sein..."

    # game/core/09_opportunities.rpy:4
    old "Теперь с тётей Кирой ещё больше развлечений! Мы наверняка можем заняться сексом у ТВ и в ванне..."
    new "Mit Tante Kira macht es jetzt noch mehr Spaß! Wir können wahrscheinlich Sex vor dem Fernseher und in der Badewanne haben..."

    # game/core/09_opportunities.rpy:4
    old "Потребуются успехи в возможности \"Блог\"..."
    new "Es wird einige Fortschritte bei der \"Blogging-Möglichkeit\" brauchen..."
    ...
    new "Lisa bemerkte, dass ich sie beim Duschen beobachtete. Ich versuchte, mich zu entschuldigen und versprach, ihr Süßigkeiten zu kaufen. Im Gegenzug wird Lisa Mom nichts sagen, aber ich habe nicht viel Zeit..."
    ...
    new "Ich muss mich mit dem Einkaufen der Süßigkeiten beeilen! Ich dachte, Lisa hätte gesagt, dass sie keine Süßigkeiten mag. Wie auch immer, mir läuft die Zeit davon..."
    ...
    new "Ich hatte keine Gelegenheit, Lisa ihre Süßigkeiten rechtzeitig zu besorgen, also erzählte sie Mom von meiner Spionage. Wenn Lisa mich wieder erwischt, habe ich vielleicht noch eine Chance..."

    # game/core/09_opportunities.rpy:4
    old "Но не стоит торопиться... Если Лиза заметит меня за тем же самым занятием, спустя всего лишь пару дней, будет только хуже."
    new "Aber das hat keine Eile... Wenn Lisa mich nach ein paar Tagen dabei ertappte, wie ich dasselbe mache, würde das die Sache nur noch schlimmer machen."

    # game/core/09_opportunities.rpy:4
    old "Главное, чтобы были деньги на покупку сладостей, а остальное - уже ерунда..."
    new "Die Hauptsache ist, dass ich das Geld habe, um Süßigkeiten zu kaufen, denn alles anddere ist fast unwichtig..."
    ...
    new "Ich habe Lisa \"Ferrero Rocher\" Bonbons gekauft, und wie sich herausstellte, mag sie sie nicht! Nächstes Mal wäre es besser, ihr etwas anderes zu geben..."

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, какие сладости Лиза не любит. Я это запомню..."
    new "Wenigstens weiß ich jetzt genau, welche Süßigkeiten Lisa nicht mag. Ich werde das im Hinterkopf behalten..."
    ...
    new "Ich kaufte Lisa \"Raffaello\" Süßigkeiten und sie nahm sie an, aber nicht sehr begeistert. Vielleicht sollten Sie ihr nächstes Mal etwas anderes geben?"

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, за какие сладости Лиза почти наверняка не сдаст меня маме. Я это запомню..."
    new "Wenigstens weiß ich jetzt, für welche Süßigkeiten Lisa mich mit ziemlicher Sicherheit nicht bei Mom verpfeifen wird. Ich werde das im Hinterkopf behalten..."
    ...
    new "Ich habe \"Ritter Sport\" für Lisa gekauft und sie war sehr zufrieden damit! Natürlich war sie das, es stellte sich heraus, dass es ihre Lieblingssüßigkeit war! Vielleicht sollte ich ihr das nächste Mal eine große Packung besorgen?"
    ...
    new "Ich war so dumm! Und warum habe ich Lisa so dreist ausspioniert, und nicht einmal ein paar Tage gewartet?! Ich bestreite nicht, dass ich dafür gerecht vor allen Leuten bestraft wurde, aber es ist wohl dooch besser, es nicht noch einmal zu tun und lieber ein bisschen länger zu warten."
    ...
    new "Die Lektion wurde durch Schmerz und Demütigung verstärkt. Wo ist meine Geduld? Ich muss mich mindestens drei Tage lang von Lisa fernhalten, damit das nicht wieder passiert..."
    ...
    new "Sieht so aus, als bekäme man eine große Umarmung, wenn man Süßigkeiten besorgt, die Lisa mag! Und das trotz der Tatsache, dass ich ihr nachspioniert habe. Mal sehen, was ich noch von meiner Schwester bekommen kann..."
    ...
    new "Jetzt war klar, wie einfach es sein würde, Lisa davon zu überzeugen, mich nicht an Mom zu verraten. Aber es ist das Risiko nicht wert, ihr in den nächsten Tagen nachzuspionieren, nachdem wir das alles geklärt haben..."
    ...
    new "Umarmungen sind nicht das Einzige, was ich als Gegenleistung dafür bekommen kann, dass ich Lisa Süßigkeiten gebe. Sie war so glücklich, dass sie mich sogar auf die Wange geküsst hat! Ich hätte nicht gedacht, dass sich das Bespitzeln meiner Schwester als so angenehme Überraschung erweisen könnte! Ich frage mich, wie es weitergeht..."
    ...
    new "So entschuldigt man sich bei Lisa! Aber es ist das Risiko nicht wert, sie in den nächsten Tagen zu beobachten, nachdem wir das alles geklärt haben..."
    ...
    new "Es scheint, dass Süßigkeiten für Lisa nicht genug sind. Jetzt will sie einen Bademantel wie den von Alice. Das ist ein ernsthafter Kauf! Ich habe mehr Zeit, um es zu besorgen, aber es ist trotzdem besser, sich mit dem Geschenk zu beeilen. Ich frage mich, was ich dafür bekomme..."

    # game/core/09_opportunities.rpy:4
    old "У меня всего пара дней. Дело плёвое, если есть деньги..."
    new "Ich habe nur ein paar Tage Zeit. Es ist ein Kinderspiel, wenn man das Geld hat..."
    ...
    new "Lisa gibt mir nicht mehr nur Küsse, sie springt mich an, um mich zu umarmen! Vielleicht sollte ich die Initiative ergreifen? Es könnte sich jetzt lohnen, zu gucken, solange ich die richtige Entschuldigung dafür finde."
    ...
    new "Jetzt, wo Lisa nicht nach Süßigkeiten für meine Missetaten fragt, kann ich sie ihr einfach so von Zeit zu Zeit schenken, um ihre Stimmung zu verbessern. Und es würde unserer Beziehung sicherlich nicht schaden. Einmal pro Woche - das ist gut!"
    ...
    new "Es ist vielleicht nicht auf die beste Art und Weise passiert, aber jetzt hat Lisa den Bademantel, nach der sie sich gesehnt hat. Hoffentlich kann ich sie irgendwann einmal in die Finger bekommen."
    ...
    new "Dieses Mal hat Lisa nicht nach Süßigkeiten oder Kleidung gefragt... Sie hat beschlossen, mich \"zu bestrafen\", indem wir vor dem Schlafengehen gemeinsam Filme schauen! Das ist okay, aber wir werden uns romantische Filme ansehen... Ich hoffe nur, es ist erträglich, denn ich liebe es, Lisa beim Duschen zuzusehen."

    # game/core/09_opportunities.rpy:4
    old "Если Лиза заметила, как я за ней подглядывал, то лучше в полночь вернуться в нашу с ней комнату, чтобы посмотреть фильм..."
    new "Wenn Lisa bemerkt hat, dass ich ihr nachspioniert habe, sollte ich besser um Mitternacht wieder in meinem Zimmer sein, um den Film zu sehen..."
    ...
    new "Lisas Idee, die Liebesgeschichte zu schauen, war besser, als ich dachte! Zumindest für mich. Schwesterchen in Unterwäsche neben mir im selben Bett! Und auf dem Bildschirm und sexy Szenen, und so, dass ich einen Ständer bekam! Lisa war nicht glücklich darüber, aber wir werden sehen, was als nächstes passiert..."
    ...
    new "Wir müssen diese Late-Night-Vorführungen unbedingt fortführen. Vielleicht gewöhnt sich Lisa an mich und ich gewöhne mich an sie..."
    ...
    new "Lisa war es leid, dass ich beim Anschauen von romantischen Filmen einen Steifen bekam, und hat beschlossen, dass wir uns jetzt etwas ansehen würden, bei dem ich definitiv keine Erektion bekommen würde - Horrorfilme! Ja, Horrorfilme vor dem Schlafengehen, im Dunkeln... Meine Schwester ist verzweifelt!"
    ...
    new "Es war mitten in einem Horrorfilm und es half nichts gegen mein Ständer... Lisa hat sich mit ihrem fast nackten Körper so eng an mich geschmiegt, dass es sehr schwer ist, sich zurückzuhalten und nicht erregt zu werden... Ich muss versuchen zu widerstehen, dann läuft Lisa nicht so schnell weg?"

    # game/core/09_opportunities.rpy:4
    old "Легко сказать! Но чем больше у меня будет сексуальных развлечений, тем проще мне будет сдерживаться с Лизой..."
    new "Das ist leicht gesagt! Aber je mehr sexuelle Erfahrung ich habe, desto leichter wird es mir fallen, mich bei Lisa zu beherrschen..."
    ...
    new "Ich konnte den Moment nutzen, um ihr einen Gute-Nacht-Kuss zu geben, damit sie sich nicht so sehr fürchtet! Vielleicht könnte ich sie irgendwann auch nackt bekommen. Das wäre großartig!"
    ...
    new "Ich muss Lisa unbedingt öfter vor den Strafen von Mom schützen. Es ist nur gut für unsere Beziehung..."
    ...
    new "Ich frage mich, ob Lisa damit einverstanden wäre, Horrorfilme ohne ihr Oberteil anzuschauen. Sie und ich sind uns ziemlich nahe gekommen, aber ich weiß nicht, wie ich sie dazu überreden soll. Aber es ist besser, es an dem Tag zu tun, an dem Mom sie bestrafen wollte."

    # game/core/09_opportunities.rpy:4
    old "Времени немного. Нужно успевать до того, как Лиза ляжет спать..."
    new "Es bleibt nicht viel Zeit. Ich muss dort sein, bevor Lisa ins Bett geht..."
    ...
    new "Ich beobachtete Alice beim Duschen und sie bemerkte mich. Als ich versuchte, mich zu entschuldigen, versprach ich ihr, ihr Süßigkeiten zu kaufen, im Gegenzug dafür, dass sie Mom nicht alles erzählt. Überraschenderweise bin ich noch am Leben, aber ich habe nicht mehr viel Zeit..."
    ...
    new "Ich muss mich mit dem Einkaufen der Süßigkeiten beeilen! Wenn ich mich richtig erinnere, mag sie etwas in einer goldenen Verpackung. Wie auch immer, mir läuft die Zeit davon..."
    ...
    new "Leider habe ich Alice nicht rechtzeitig was Süßes geschenkt, und so erzählte sie Mom, wie ich ihr nachspioniert habe. Vielleicht schaffe ich es nächstes Mal, wenn Alice mich entdeckt..."
    ...
    new "Aber es hatte keine Eile... Wenn Alice mich nach ein paar Tagen dabei beobachten würde, wie ich dasselbe mache, würde sie am liebsten sofort aus dem Haus stürmen."

    # game/core/09_opportunities.rpy:4
    old "Я купил для Алисы конфеты \"Raffaello\" и как оказалось, они ей не нравятся! В следующий раз, лучше подарить что-то другое..."
    new "Ich habe als Süßigkeiten \"Raffaello\" für Alice gekauft, und wie sich herausstellte, mag sie sie nicht! Nächstes Mal ist es besser, etwas anderes zu geben..."

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, какие сладости Алиса не любит. Я это запомню..."
    new "Wenigstens weiß ich jetzt, welche Art von Süßigkeiten Alice nicht mag. Ich werde das im Hinterkopf behalten..."
    ...
    new "Ich kaufte eine Schokolade \"Ritter Sport\" für Alice und sie nahm sie an, aber ohne viel Enthusiasmus! Vielleicht sollte ich ihr beim nächsten Mal etwas anderes geben?"

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, за какие сладости Алиса не выпнет меня под зад. Я это запомню..."
    new "Wenigstens weiß ich jetzt, für welche Art von Süßigkeiten Alice mir nicht in den Hintern treten wird. Ich werde das im Hinterkopf behalten..."
    ...
    new "Ich habe Alice Süßigkeiten \"Ferrero Rocher\" gekauft und sie war sehr glücklich! Natürlich stellte sich heraus, dass es ihr Lieblingskonfekt war! Vielleicht sollten ich ihr das nächste Mal eine grosse Schachtel dieser Süssigkeiten schenken."
    ...
    new "Ich bin so ein Idiot! Warum habe ich Alice so dreist ausspioniert, ohne auch nur ein paar Tage zu warten?! Ich wurde vor allen Leuten bestraft... Das nervt! Ich meine, es ist scheiße, aber ich sollten es einfach eine Weile abwarten."
    ...
    new "Die Lektion wurde durch Schmerz und Demütigung verstärkt. Wo war meine Geduld? Ich musste Alice mindestens drei Tage lang in Ruhe lassen, damit das nicht wieder passiert..."
    ...
    new "Äh... Wenn ich gewusst hätte, dass Alice mir nur die Ohren verdrehen würde, hätte ich daran gedacht, ihr Süßigkeiten zu geben! Obwohl ich dann riskiere, vor allen Leuten bestraft zu werden, was noch schlimmer ist... Es ist also besser, beim nächsten Mal ein Risiko einzugehen, für den Fall, dass ich Glück habe und Alice mir nichts antut."

    # game/core/09_opportunities.rpy:4
    old "Но не стоит рисковать подглядывать за ней в ближайшие дни, после того, как мы всё уладили! Чревато..."
    new "Ich sollte nicht riskieren, sie in den nächsten Tagen zu beobachten, nachdem wir alles geklärt haben! Das ist anstrengend..."
    ...
    new "Wie sich herausstellte, kann man für die Süßigkeiten, die Alice mag, nicht nur die Ohren intakt lassen, sondern auch ihre bescheidene Umarmung spüren! Und das, obwohl ich ihr nachspioniert habe. Mal sehen, was ich noch von meiner großen Schwester bekomme..."
    ...
    new "Jetzt war klar, wie einfach es sein würde, Alice davon zu überzeugen, mich nicht an Mom zu verraten. Aber es ist das Risiko nicht wert, ihr in den nächsten Tagen nachzuspionieren, nachdem wir alles geklärt haben..."
    ...
    new "Es scheint, dass Alices Süßigkeiten nicht genug sind, und jetzt wird sie Bedingungen stellen! Sie will, dass ich ihr einen Pyjama kaufe, und das ist eine größere Anschaffung! Ich habe diesmal mehr Zeit, aber es ist immer noch besser, sich mit dem Geschenk zu beeilen. Ich frage mich, was ich dafür bekomme..."
    ...
    new "Alice willigte ein, mich in ihr Zimmer zu lassen, während sie ihren Pyjama anprobierte! Natürlich bat sie mich, nicht zu gucken, obwohl sie wusste, dass ich... Und ihre Drohungen wurden zu einer Art Witz. Ich frage mich, wozu das führen wird? Gucken ist also erlaubt, wenn man sich richtig entschuldigt."
    ...
    new "Jetzt, wo Alice nicht nach Süßigkeiten für meine Missetaten fragt, kann ich sie ihr einfach so von Zeit zu Zeit schenken, um ihre Stimmung zu verbessern. Und es würde unserer Beziehung sicherlich nicht schaden. Einmal pro Woche - das ist gut!"
    ...
    new "Mit einiger Mühe habe ich Alice einen Pyjama gekauft und geschenkt. Es passierte nicht so, wie ich es mir gewünscht hatte, aber es war besser als nichts. Ich fragte mich, wonach sie das nächste Mal fragen würde."
    ...
    new "Mal sehen, ob Alice immer frecher wird mit ihren Forderungen..."
    ...
    new "Ich habe mich nochmal bei Alice entschuldigt, aber etwas ist schief gelaufen... Sie verlangte nichts, sagte nur, dass die Strafe, die sie für mich vorgesehen hatte, auf den Abend verschoben wird. Aber ich sollte auf jeden Fall zu ihr kommen, wenn sie kurz vorm Einschlafen noch fernsieht. Ich könnte natürlich nicht hingehen, aber dann würde Alice Mom am nächsten Tag alles über mein Spionieren erzählen und ich würde trotzdem vor allen bestraft werden. Es wäre also gut zu wissen, was Alice mit mir vorhatte. Nur mal so zum Vergleich..."

    # game/core/09_opportunities.rpy:4
    old "Теперь, если мне есть за что извиняться перед Алисой, нужно подходить к ней, когда она смотрит ТВ..."
    new "Wenn ich mich bei Alice für etwas entschuldigen will, muss ich zu ihr gehen, wenn sie fernsieht..."
    ...
    new "Ich musst Alice wieder beim Duschen beobachten. Die Hauptsache ist, dass ich dann Abends, an dem sie fernsieht, zu ihr zu gehe..."
    ...
    new "So seltsam es klingt, ich muss mir überlegen, wie Alice mich für das Spionieren bestrafen soll. Und dann hätte man die Qual der Wahl..."
    ...
    new "Es lohnt sich, Alice mit Alkohol und Süßigkeiten zu besänftigen, bevor wir in ihr Zimmer gehen, wo sie mich bestrafen wird..."
    ...
    new "Oh, Eric ist ein Lügner! Oder habe ich vielleicht etwas missverstanden? So oder so, ich muss mit Eric reden und herausfinden, was genau mir diese Freundschaft mit ihm bringt... Denn so - ist das alles großer Misst!"

    # game/core/09_opportunities.rpy:4
    old "С Эриком можно поговорить наедине, только когда он один в комнате мамы..."
    new "Die einzige Zeit, in der man mit Eric unter vier Augen sprechen kann, ist, wenn er allein im Zimmer meiner Mutter ist..."
    ...
    new "Eric sagte, er würde sich etwas einfallen lassen, damit ich ihn und Mom ungestört beobachten kann. Leider kann ich das nur herausfinden, wenn ich sie immer wieder beobachte... Ich will nicht schon wieder von Momr vor allen Leuten bestraft werden, und das für so etwas. Aber ich muss sehen, ob diese Freundschaft etwas wert ist..."

    # game/core/09_opportunities.rpy:4
    old "Нужно и дальше подглядывать за мамой и Эриком в спальне, чтобы убедиться, что мне ничего за это не будет..."
    new "Ich muss immer wieder Mom und Eric im Schlafzimmer beobachten, um sicherzugehen, dass ich keine Probleme deswegen bekomme..."
    ...
    new "Stimmt das? Mom hat mich erwischt während Sie und Eric gefickt haben und wollte mich bestrafen, aber Eric hat nein gesagt und Mom hat zugestimmt?! Es ist schwer zu glauben, aber es ist wirklich wahr. Ich weiß nicht, wie er es gemacht hat, aber es ist fantastisch! Jetzt kann ich ihnen wirklich beim Ficken zusehen und bekomme dafür keine Strafe."

    # game/core/09_opportunities.rpy:4
    old "Нужно и дальше подглядывать за мамой и Эриком в спальне..."
    new "Ich soollte weiter Mom und Eric im Schlafzimmer beobachten..."
    ...
    new "Mom hat mich wieder bemerkt. Sie wollte mich wegjagen, aber Eric ging dazwischen und sagte, dass ich im Zimmer anwesend sein könnte, während sie es treiben... Und meine Mom, die mir sogar verboten hat, Erotik anzusehen, war damit einverstanden! Das ist unglaublich. Entweder ist Eric eine Art Zauberer, oder es ist etwas anderes und ich muss das auf jeden Fall herausfinden."

    # game/core/09_opportunities.rpy:4
    old "Теперь я могу просто заходить к ним в спальню и смотреть на то, что они делают..."
    new "Jetzt kann ich einfach in ihr Schlafzimmer gehen und sehen, was sie machen..."
    ...
    new "Oh, Mist! Wie hat Eric nur diese Wirkung auf Mom?! Ohne jede Anstrengung nahm er sie einfach und überzeugte sie, ihm weiter einen zu blasen, während ich zusah... Mom ist natürlich nicht sehr glücklich darüber, aber sie wollte nicht aufhören! Kann mir mal Bitte jemand erklären, wie man das macht und wo man das lernt?!"

    # game/core/09_opportunities.rpy:4
    old "Посмотрим, как долго я смогу за ЭТИМ наблюдать..."
    new "Mal sehen, wie lange ich DAS sehen kann..."
    ...
    new "Das ist unglaublich! Jetzt hat Eric das, was er mit Mom machen, in ein Lernprogramm verwandelt... Ich beschwere mich nicht, aber Mom macht definitiv Dinge, die sie ohne Eric niemals in ihrem Leben tun würde! Wie geht es in diesem Fall weiter?"
    ...
    new "Eric ist sogar noch weiter gegangen und steckt seinen Schwanz jetzt so tief in den Mund vom Moom, wie er das will! Ich habe mehr und mehr das Gefühl, dass er so geil drauf ist, zu zeigen, dass er alles bekommt, was er will... Nun, ich werde einen Weg finden, ihn dazu zu bringen, es zu lassen. Ich muss nur herausfinden, was das Geheimnis seiner Manipulationen ist und ob sie bei meinen Schwestern genauso gut funktionieren..."
    ...
    new "Das Liefermädchen wurde misstrauisch wegen meiner ständigen Bestellungen von Frauenkleidern. Ihr Name ist Christina. \nIch habe mich nicht getraut, sie anzumachen, sie würde mich definitiv abweisen. Obwohl, es ist ja nicht so, als hätte ich etwas zu verlieren, wenn ich es versuche..."
    ...
    new "Das Liefermädchen interessierte sich für meine verdächtigen Bestellungen von Frauenkleidern. Ihr Name ist Christina. \nDie klügste Entscheidung für mich war, sie sofort anzubaggern, aber was geschehen ist, ist geschehen. Es ist klar, dass sie mich sowieso abgewiesen hätte, aber einen Versuch war es wert..."
    ...
    new "Ich habe zufällig bemerkt, wie Eric mitten in der Nacht am Fenster zu Alices Zimmer stand und sich auf sie einen runterholte! Das hätte ich nicht erwartet... Ich dachte, Eric wäre die Art von Kerl, der sich lieber eine Nutte holt, als sich nur einen runterzuholen, aber wie sich jetzt herausstellt... Ich habe mich geirrt. Ich wette, das ist nicht das erste Mal, dass er das macht. Ich sollten ihn nachts beobachten, um ein Bild von seinen schmutzigen Taten zu machen... Es ist besser, die Kamera griffbereit zu haben, falls etwas passiert..."

    # game/core/09_opportunities.rpy:4
    old "Похоже, Эрик иногда не может удержаться и идёт дрочить на Алису. Это происходит около двух часов ночи..."
    new "Eric kann sich manchmal nicht beherrschen und holt sich bei Alice einen runter. Es passiert gegen zwei Uhr nachts..."
    ...
    new "Ich habe es geschafft! Ich habe ein Foto von Eric gemacht, wie er sich auf Alice einen runterholt! Natürlich ist nicht wirklich klar, zu bei wem oder vor was er sich einen runterholt, also wäre dieses Bild keine große Hilfe für mich, falls es Ärger mit Eric geben sollte.\n\nEs wäre schön, wenn Eric so dreist wäre, sich mitten in ihrem Zimmer auf Alice einen runterzuholen... Das wäre eine Art von Dreck. Alice wäre im Bild, aber der Fokus würde auf Eric liegen. Ich muss nur herausfinden, wie ich ihn in Alices Zimmer kriegen... Vielleicht sollte ich sie dazu bringen, nackt zu schlafen?!"

    # game/core/09_opportunities.rpy:4
    old "Алису точно не удастся уговорить спать голышом, если её даже не наказывали голой..."
    new "Alice kann sicher nicht dazu überredet werden, nackt zu schlafen, wenn sie vorher nicht einmal nackt bestraft wurde..."

    # game/core/09_opportunities.rpy:4
    old "Помогут наши с Алисой договорённости, когда она исполняет мои пикантные прихоти, а я молчу, что она курит..."
    new "Es hilft, dass Alice und ich eine Vereinbarung haben, dass sie meine unartigen Ideen ausführt und ich sie nicht verrate, wenn sie raucht..."
    ...
    new "Ich wusste, dass Eric einer nackten, schlafenden Alice nicht widerstehen konnte! Wirklich, kannst du ihm das verübeln? Ich würde auch nicht widerstehen können... Jetzt müssen wir nur noch das Foto machen, während er in ihrem Zimmer ist..."

    # game/core/09_opportunities.rpy:4
    old "Остаётся лишь успеть сфотографировать Эрика, пока он ещё дрочит на Алису..."
    new "Ich muss nur ein Foto von Eric machen, während er sich auf Alice einen runterholt..."
    ...
    new "Vielleicht sollte ich mir die Kisten vornehmen, von denen Mom gesprochen hat..."

    # game/core/09_opportunities.rpy:768
    old "Может, стоит интересоваться, чем живёт моя старшая сестрёнка, когда не сидит в своей комнате..."
    new "Vielleicht sollte man sich mal fragen, wovon meine große Schwester eigentlich ihre Ausgaben finanziert, wenn sie nicht in ihrem Zimmer ist..."
    ...
    new "Vielleicht sollte man sich fragen, wie das Leben meiner kleinen Schwester verläuft, wenn sie nicht in ihrem Zimmer ist..."
    ...
    new "Vielleicht hat Alice ein paar geheime Hobbys? Wenn ja, wird sie es offensichtlich machen, wenn zu Hause am wenigsten los ist..."
    ...
    new "Um Lisa nach ihrer Klassenkameradin zu fragen, sollte ich mich vorher vergewissern, dass sie gut gelaunt ist..."

    # game/core/09_opportunities.rpy:768
    old "С тётей Кирой о стольком можно поговорить! Нужно успевать, пока она нежится на солнце..."
    new "Es gibt mit Tante Kira so viel zu besprechen! Ich muss mir Zeit nehmen, während sie sich sonnt..."
    ...
    new "Wenn meine Schwestern sehen würden, wie ich sie beim Duschen beobachte, bekäme ich eine Menge Ärger. Aber wenn es etwas gibt, was ich tun kann, damit sie sich besser fühlen..."

    # game/core/09_opportunities.rpy:768
    old "Эта возможность доступна только при дружбе с Эриком..."
    new "Diese Option ist nur verfügbar, wenn Ich mit Eric befreundet bin..."
    ...
    new "Eric deutete an, dass ich einen Blick darauf werfen dürfe, was er und Mom alleine machten. Jetzt ist es sicher, sie im Schlafzimmer zu beobachten..."
    ...
    new "Eric hat eindeutig ein besonderes Interesse an Alice. Ich muss ein Auge auf die beiden haben, wenn sie zusammen sind. Aber auch in der Nacht kann schon mal etwas Unanständiges passieren, wenn plötzlich nicht mehr alle schlafen..."
...
translate german strings:
    ...
    new "Was für eine Wendung! Da Lisas Sexualerziehung nun mir anvertraut wurde, habe ich den Bonus verloren, den mir Eric versprochen hatte. Lisa ist der Bonus, verstehst Du? \nEr hat zwar angedeutet, dass ich, wenn ich ihm etwas zu erzählen hätte, andere Vorteile haben würde. \nIch habe Eric sofort von mir und Kira erzählt und er war angenehm überrascht! Er hat sich gewundert, dass ich nebenbei noch eine Pornodarstellerin haben... \nJetzt muss ich mit Kira in der Badewanne für Eric mitspielen, wenn er uns zufällig erwischt, damit er es auch mit ihr leichter hat, und ich darf dafür beim Sex mit ihr und Mom dabei sein! Naja, mit einigen Vorbehalten. Mom wird mich nicht sehen, und ich wiederum darf keine Geräusche machen. Ich glaube, ich schaffe das schon. Oh, das wird fantastisch werden!"
...
translate german strings:
    ...
    new "Ich hoffe, Mom bekommt keinen Ärger auf der Arbeit, weil sie sich mit Eric gestritten hat. Das wird sich mit der Zeit zeigen, aber in der bis dahin sollte ich mit den anderen über Eric reden..."
    ...
    new "Man muss im Auge behalten, was Mom vorhat. Vielleicht wird Eric ihr auf die Nerven gehen und sie wird anfangen, Trost in etwas anderem zu suchen... nicht gut..."
    ...
    new "Das ist es! Mom hat begonnen, ihren Kummer in Alkohol zu ertränken. Natürlich nicht in einem riesigen und konstanten Ausmaß, aber eine kleine Menge reichte aus, um sie umzuhauen. Mit nur einem Glas Wein musste ich ihr schon aufs Zimmer helfen. Es wird mir nichts bringen, aber ich habe die Schwäche meiner Mutter ausgenutzt... Ich habe ihr beim Anziehen geholfen... Bin bei ihr geblieben... Für den Fall der Fälle. Was war ich überrascht, als sie anfing, mich zu umarmen und mit mir zu flirten! Ich weiß nicht, an wen sie in diesem Moment gedacht hat, aber sicher nicht an mich. Es ist unwahrscheinlich, dass Mom das erklären kann, aber einen Versuch ist es wert. Zur Not könnte man auch Tante Kira fragen."

    # game/core/09_opportunities.rpy:4
    old "Сперва нужно поговорить с мамой о том, что это такое ночью она вытворяла..."
    new "Zuerst muss ich mit Mom darüber reden, was sie nachts gemacht hat..."

    # game/core/09_opportunities.rpy:4
    old "Неплохо бы поинтересоваться у тёти Киры, пока она загорает, о том, как на маму действует алкоголь..."
    new "Es ist eine gute Idee, Tante Kira beim Sonnen nach den Auswirkungen von Alkohol auf Mom zu fragen..."

    # game/core/09_opportunities.rpy:4
    old "Теперь, если мама снова будет прикладываться к выпивке, то я знаю, как ей стоит подыграть, чтобы нам обоим было хорошо..."
    new "Wenn Mom jetzt noch einen Drink bekommt, weiß ich, wie ich vorgehen muss, damit wir uns beide gut fühlen..."
    ...
    new "Es sieht so aus, als hätte Kira recht gehabt! Mom ist in eine Art Fantasie versunken, als sie betrunken war. Anscheinend über den perfekten Mann... Nun, ich kann diese Fantasie unterstützen! Aber es wird nicht leicht sein, denn sie ist meine Mom! Sie hat meinen Schwanz noch nie richtig im Mund gehabt, aber ich bin schon so erregt, als wäre es mein erstes Mal. Es ist wirklich das erste Mal, dass ich mit meiner Mutter zusammen bin. Oh, was passiert wohl, wenn ich lange genug durchhalte..."

    # game/core/09_opportunities.rpy:4
    old "Мне бы надо постараться не перевозбуждаться так сильно от маминых ласк, чтобы получить больше..."
    new "Ich sollte versuchen, mich nicht zu sehr von den Zärtlichkeiten meiner Mom erregen zu lassen, damit ich mehr..."
    ...
    new "Wie toll ist es, die Fantasien von Mom zu fördern, wenn sie betrunken ist! Sie bläst genau so, wie ich es haben will, mmm... Und mit ihrer Pussy zu spielen ist ein Vergnügen! Ich halte es nicht mehr aus, ich will sie so gerne ficken... Und ich kann... Vermutlich... Aber zunächst ist es besser, sich an das zu gewöhnen, was wir gerade tun. Und das tun wir nicht so oft. Ich muss weiter mitspielen und dann werde ich sie so hart ficken..."
    ...
    new "Man muss sich zumindest ein bisschen an einen Blowjob von Mom gewöhnen, damit man es bei ihr nicht mehr versaut. Erfolgreich einen Blowjob von Mom ausgehalten: [ann.flags.held_out] von 3"
...
translate german strings:
    ...
    new "Nach all den intimen Lektionen, die mir Mom in der Badewanne gegeben hat, ist sie schon viel entspannter, was meine Erregung während der Massage angeht. Vielleicht stört es sie in Zukunft nicht mehr und sie lässt sich von mir nicht nur den Rücken und die Schultern, sondern auch die Brüste massieren?"
    ...
    new "Nach all diesen nächtlichen Fantasien von Mom ist sie schon viel entspannter, was meine Erregung während der Massage angeht. Vielleicht stört es sie in Zukunft nicht mehr und sie lässt sich von mir nicht nur den Rücken und die Schultern, sondern auch die Brüste massieren?"

    # game/core/09_opportunities.rpy:4
    old "Через несколько дней нужно будет спросить маму о том, подумала ли она о моей просьбе..."
    new "In ein paar Tagen sollte ich Mom fragen, ob sie über meine Bitte nachgedacht hat..."

    # game/core/09_opportunities.rpy:4
    old "Чтобы у меня появилась возможность начать интимные уроки с мамой, нужно чтобы она смотрела ТВ одна..."
    new "Damit ich in der Lage bin, intime Lektionen mit Mom zu beginnen, muss sie alleine fernsehen..."
    ...
    new "Endlich konnte ich mit Mom und Eric eine Pornoshow genießen! Tante Kira jedoch würde sich nun vor Eric für meine Marotten verantworten müssen... Zwischen den Terminen muss man einen Weg finden, Kira und Eric zu treffen. Vielleicht sogar mitmachen bei... Vergnügen... Oh, und Mom könnte versuchen, sie dazu zu bringen, den Blowjob-Unterricht fortzusetzen, den Eric organisiert hat. Wenigstens konnte ich mich darüber beschweren, dass mir niemand erklärt hatte, wie man Frauen gefallen kann!"
    ...
    new "Um die stärkste Wirkung beim Thema Sexualkundeunterricht zu erzielen, sollte man mit Mom reden, wenn sie gerade ein Bad nimmt..."
    ...
    new "Schließlich haben Mom und ich uns ein paar Pornos angesehen, und zwar zu angeblich erzieherischen Zwecken. \nAls ich sie gefragt habe, wann wir das, was wir gesehen haben, üben werden, war sie seltsamerweise sehr überrascht. Sie dachte wohl, sie käme damit durch, dass wir uns Pornos mit Erläuterungen ansehen. \nAber meine Kühnheit kennt keine Grenzen und innerhalb weniger Minuten küsste ich ihren Hals und massierte ihre Brüste! Einfach fabelhafte Brüste! \nAber als es darum ging, tiefer zu gehen... Mom war völlig unwillig. \nNun, das ist kein Problem, denn Tante Kira ist immer da, um zu helfen. Und ich glaube, mein Gefühl für Tante Kira wird meine Mutter auf Trab halten. Sie wird dafür sorgen, dass wir so etwas nicht tun, sobald sie Zeit hat."
    ...
    new "Sonntags verbringt Mom die Nacht zu Hause und ist zudem allein. Perfekte Bedingungen für sie, um nicht schlafen zu können, bis sie überprüft hat, ob ich die Nacht mit Kira verbringe..."
    ...
    new "Zu sagen, dass Mom von dem, was sie gesehen hat, schockiert war, ist nicht der Rede wert. Tante Kira hatte ihre Rolle gut gespielt, und Mom war nicht mehr so verbissen in Bezug auf Intimunterricht. Solange ich es nicht von der lüsternen Kira gezeigt bekomme. Außerdem werden Mom und ich unseren Unterricht dort fortsetzen, wo meine Eigeninitiative begonnen hat... Im Badezimmer! Aber das wäre nur möglich, wenn Erik nicht in unserem Haus ist."

    # game/core/09_opportunities.rpy:4
    old "Нужно пойти к маме, когда она принимает ванну..."
    new "Ich muss zu Mom gehen, wenn sie ein Bad nimmt..."

    # game/core/09_opportunities.rpy:4
    old "Нужно пойти к маме, когда она принимает ванну. И лучше стучаться, а не врываться..."
    new "Man muss ins Bad zu Mom gehen, wenn sie gerade ein Bad nimmt. Und es ist besser, anzuklopfen, als einfach nur hereinzuplatzen..."
    ...
    new "Zu sagen, dass Mom von dem, was sie gesehen hat, schockiert war, ist nicht übertrieben. Tante Kira hatte ihre Rolle gut gespielt, und Mom war nicht mehr so verbissen in Bezug auf Intimunterricht. Solange ich es nicht von der lüsternen Kira gezeigt bekomme. Außerdem werden Mom und ich unseren Unterricht dort fortsetzen, wo meine Eigeninitiative begonnen hat... Im Badezimmer! \nIch wünschte nur, wir könnten Eric ausschalten, damit er uns da drin nicht erwischt. Abführmittel sind definitiv out."
    ...
    new "Intimunterricht mit einer völlig nackten Mom in der Badewanne... Uff... So etwas hätte ich mir nicht träumen lassen. Obwohl, was soll ich sagen, es ist genau das, wovon ich geträumt habe! Es ist klar, dass es nicht leicht für sie ist, mir das beizubringen, aber als ich ihre Brüste mit meinen Händen und meiner Zunge liebkoste, genoss sie es definitiv. Das bedeutete, dass es für sie schwer sein würde, zu widerstehen und nicht weiter zu gehen... Aber die Peinlichkeit, dass ihr Sohn das tut, auch wenn es zu erzieherischen Zwecken geschieht, könnte diese Freude zunichte machen."
    ...
    new "Meine Finger sind an die Pussy von Mom gekommen! Sie hat mir so viele Ratschläge gegeben... Ich denke, sie macht das mit dem wett, was sie von Eric nicht bekommt. Bei einer Frau wie ihr muss man 100% geben, sie ist es wert. Eric will nur sich selbst gefallen. Oh, das solltest du nicht tun, Eric... \nJetzt habe ich meine Zweifel, dass dieser Unterricht fortgesetzt wird. Mom ist überrascht, dass ihr meine Kunstfertigkeit gefällt, und ich habe ihr dann ganz ungeniert einen Orgasmus verscahfft. Aber vielleicht kommt sie ja darüber hinweg..."
    ...
    new "Misst, das ist nicht nach Plan verlaufen... Nein, im Großen und Ganzen war es in Ordnung, aber ich bin eindeutig zu weit gegangen, als ich Mom mit meiner Zunge zum Orgasmus gebracht habe. Wir wollten das Gelernte vertiefen, und ich habe mich nicht zurückgehalten und ihr gezeigt, was ich kann. Ich hätte das nicht tun sollen... Und ich konnte nicht anders, als danach direkt auf sie abzuspritzen... \nMom machte ziemlich deutlich, dass unsere intimen Lektionen vorbei sind. Was soll ich jetzt tun?"
    ...
    new "Nach all den intimen Lektionen, die Momr mir in der Badewanne erteilt hat, sieht sie meine Erregung während der Yogastunden schon viel gelassener. Vielleicht stört sie das in Zukunft gar nicht mehr, und ich kann das Yoga noch interessanter machen?"
...
translate german strings:
    ...
    new "Nur für den Fall, dass du etwas Geld sparen musst, mindestens $1500, denn es ist nicht klar, was Alice kaufen will..."
    ...
    new "Es scheint, dass Alice unbedingt zeigen will, wie sie Videospiele spielt und sich dabei passend zum Thema des Spiels sexy kleidet. Und ich würde mich gerne daran beteiligen. Wir haben uns für das Black Cat-Kostüm aus dem Spider-Man-Universum entschieden, aber Alice möchte den Look mit weiteren Accessoires vervollständigen. Also werde ich einen Schnappschuss von ihr machen... Ich meine, Fotos machen."

    # game/core/09_opportunities.rpy:4
    old "Потребуются успехи в возможности \"Кто не рискует...\"..."
    new "Es wird ein gewisser Erfolg in der Möglichkeit von \"Wer nichts wagt...\" nötig sein..."
    ...
    new "Ich habe Alice nachts nicht gestört. Der Weg zurück in mein Zimmer war frei und brauche keine Krücken. Aber am Morgen, wenn Alice noch schläft, ist das eine andere Sache...\nIch hatte ihre Titten schon ein paar Mal gesehen, aber es war trotzdem schön, ihr den BH auszuziehen, und ebenso schön, dass es sie nicht aufweckte. Das Wichtigste war, dass ich in ihr Bett kommen konnte, und jetzt sollte ich weitere Schritte planen.\n\nIch frage mich, was passieren würde, wenn sie durch meine Annäherungsversuche aufwachen würde? Das gilt es herauszufinden..."

    # game/core/09_opportunities.rpy:4
    old "Желательно, чтобы Алиса проснулась от моих приставаний..."
    new "Hoffentlich wacht Alice auf, wenn ich sie belästige..."
    ...
    new "Nun, ich bin gesund und munter und voller Energie und bereit, Alice weiterhin zu belästigen. Sie hat mich zwar gebeten, sie nicht mehr zu belästigen, aber ich weiß, dass sie genau das will. Und das wird sie mir das nächste Mal zeigen müssen...\nIch bin sicher, dass ich mich da herausreden muss, wenn ich die Nacht mit ihr verbringen will, aber das ist nicht das erste Mal, dass ich das tun werde."

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать оберегать Алису от пауков в её комнате..."
    new "Alice muss vor den Spinnen in ihrem Zimmer beschützt werden..."
    ...
    new "Oh, was für ein Spaßvogel Alice doch ist! Ich lag da und tat so, als ob ich schlafe, und plötzlich... holt sie mir einen runter... Und sie redet sich heraus! Jetzt weiß ich, was in ihr vorgeht, und ich sollte genauso reagieren... Das nächste Mal... wenn ich bei ihr übernachte..."

    # game/core/09_opportunities.rpy:4
    old "Потребуются успехи в возможности \"Шаловливые ножки\"... Алиса поработала ножками без конфеты [alice.flags.sober_fj] раз из 3"
    new "Es wird einige Fortschritte bei der Möglichkeit \"freche Schenkel\" brauchen... Alice arbeitete mit ihren Füßen ohne Süßigkeiten [alice.flags.sober_fj] von 3"
    ...
    new "Eh, Alice verliert die Kontrolle... Sie drohte mir auf diese und jene Weise, aber das war mir egal... Ich stecke einfach meine Zunge in ihre Pussy. Und wie ich sie auf dem Höhepunkt ihrer Glückseligkeit gefickt habe... Sie wird wissen, dass ich auch ein Mensch bin und kommen will... auf sie... Mal sehen, ob sie darüber nachdenkt.\nIn der Zwischenzeit sollte ich besser aufhören, Spinnen in ihr Zimmer zu bri9ngen, denn das ist schon sehr verdächtig.\nOh, vielleicht lässt sie mich jetzt rein, wenn sie duscht."

    # game/core/09_opportunities.rpy:4
    old "Пустит ли меня Алиса к себе в душ для охраны, если её будет терроризировать паук? Стоит проверить..."
    new "Würde Alice mich in ihre Dusche lassen, wenn sie von einer Spinne terrorisiert würde? Es lohnt sich, das zu überprüfen..."
    ...
    new "Was für ein Glück, dass ich Alice von Nutzen sein konnte! Ich war gerade zur Stelle, als sie mich brauchte, um ihren nassen Arsch vor der Spinne zu retten. Und der Tatsache nach zu urteilen, dass sie mich ihren Arsch anfassen lässt und andeutet, dass ich beim nächsten Mal daran denken soll, ihr den Rücken zu massieren - hatte sie die richtigen Schlüsse gezogen. Zumindest glaube ich, dass sie das getan hat. Die Frage ist nur, wie lange sie noch durchhält. Ach... Ich kann den Tag kaum erwarten, an dem sie alleine duscht..."

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать оберегать Алису от пауков, когда она принимает душ..."
    new "Wenn Alice duscht, muss sie vor Spinnen geschützt werden..."
    ...
    new "Die Spinne scheint jetzt eher ein Hindernis als eine Hilfe zu sein. Ich war gerade bei dem besten Teil mit Alice angekommen, als sie hereingekrochen ist und alles ruiniert hat. Ich würde nicht sagen alles, denn ich bekam einen dankbaren Kuss von Alice, und rieb meinen Schwanz an ihrem Arsch, während sie an mir hing... Aber ich hätte mehr haben können... Vielleicht habe ich beim nächsten Mal das Glück, die Spinne zuerst zu sehen."
...
translate german strings:
    ...
    new "Oooh la la... Da hat Alice endlich aufgeholt. Mit ihr eröffnen sich mir viele interessante Wege, aber gleichzeitig wird sie nicht aufhören, ein Miststück zu sein, es wird also nicht alles glatt laufen. Wie auch immer, jetzt kann ich mir einen sehr angenehmen Morgen neben meiner großen Schwester gönnen, mit ihr duschen, vielleicht kann ich der Massage am Fernseher etwas Neues abgewinnen..."
    ...
    new "Ganz gleich, wie sehr ich mich bemühe, ihr bei der Bestrafung zu gefallen, ich brauche immer noch Fortschritte in unserer Beziehung ohne Süßigkeiten, um mehr zu erreichen. Es braucht Fortschritte bei der \"Arachnophobie-Möglichkeit\"..."
    ...
    new "Nach all diesen Abenteuern mit Spinnen hat die Beziehung zu Alice eine neue Ebene erreicht. Vielleicht ändert sich auch etwas an den Strafen..."
    ...
    new "Mist! Damit hatte ich nicht gerechnet... Ich dachte, ich könnte Alice wenigstens dazu bringen, mir einen zu blasen, aber das wird wohl nicht passieren.\nBei dieser Strafe werde ich mich ihr wohl oder übel unterwerfen müssen, damit ich mit meinem intakten Arsch davonkomme und mich damit begnügen, meine Zunge an allen möglichen Stellen von Alice' Körper zu haben. Von oben nach unten.\n\nUnd sie würde sich an nichts davon erinnern, wegen der Süßigkeiten-Aktion."

    # game/core/09_opportunities.rpy:4
    old "Возможно, получится добиться от неё того же без конфет? Стоит проверить..."
    new "Vielleicht könnte man sie dazu bringen, dasselbe auch ohne Süßigkeiten zu tun? Es lohnt sich, das zu überprüfen..."
    ...
    new "Jetzt kann ich es Alice sozusagen mit der gleichen Münze zurückzahlen, wenn sie wieder rückfällig wird, und dazu muss ich sie mit einer Zigarette erwischen oder sie durch die Strafe von Mom bewahren..."

    # game/core/09_opportunities.rpy:4
    old "Чёрт! Я, на самом деле, рассчитывал не на это... Я думал, что у меня получится развести Алису, уж как минимум, на минет, но похоже этого не будет. \nВ этих наказаниях мне в любом случае придётся подчиняться ей, чтобы уйти с целой задницей и довольствоваться тем, что мой язык побывает в самых разных местах на теле Алисы. Сверху до низу. \n\nХотя... Теперь Алисе можно будет, так сказать, отплатить той же монетой, когда она снова провинится..."
    new "Mist! Damit hatte ich nicht gerechnet... Ich dachte, ich könnte Alice wenigstens dazu bringen, mir einen zu blasen, aber das wird wohl nicht passieren.\nBei dieser Strafe werde ich mich ihr wohl oder übel unterwerfen müssen, damit ich mit meinem intakten Arsch davonkomme und mich damit begnügen, meine Zunge an allen möglichen Stellen von Alice' Körper zu haben. Von oben nach unten.\n\nObwohl... Jetzt kann Alice sozusagen belohnt werden, wenn sie wieder erwischt wurde..."

    # game/core/09_opportunities.rpy:4
    old "Нужно поймать Алису с сигаретой во рту или спасти он наказания мамы..."
    new "Man muss Alice mit einer Zigarette erwischen oder Sie vor der Bestrafung durch Mom schützen..."
    ...
    new "Das ist es, was Alice von mir erhalten hat! Trotz aller Beschimpfungen... Ich würde diesen ganzen Bestrafungsprozess gerne noch ein paar Mal wiederholen, auch wenn Alice versuchen würde, sich nicht mehr mit Zigaretten erwischen zu lassen, weder von mir noch von Mom. Sie wird sowieso nicht aufhören zu rauchen..."
    ...
    new "Man muss Alice noch einmal unter der Dusche beobachten und sich von ihr bestrafen lassen... Wahrscheinlich lohnt es sich, verschiedene Optionen auszuprobieren, mit und ohne Süßigkeiten..."
    ...
    new "Es scheint, dass Alice langsam begreift, dass es weitaus weniger schlimm ist, während der Bestrafung mir einen zu blasen, als zu versuchen, darauf zu sitzen.\nUnd jetzt, wo Blowjobs zur Bestrafung da sind, könnte es sein, dass sie auch in unseren anderen... Aktivitäten...\nEs sind zwar noch nicht viele, aber ich kann mich darauf verlassen, dass ich morgens in Alices Zimmer einen Blowjob bekomme, natürlich nicht ohne die Hilfe einer Spinne. Und dank einer Massage vor dem Fernseher besteht auch ohne die Süßigkeiten die Chance, etwas Interessantes mit Alice zu erleben..."
