...
translate german Sleep_52abcf74:
    ...
    Max_00 "{m}Ich glaube, es ist Zeit ins Bett zu gehen...{/m}" nointeract

# game/events/max.rpy:34
translate german Sleep_9878a7fd:
...
translate german delivery2_509c6af4:

    # Max_00 "Конечно! А что тут?"
    Max_00 "Klar, was ist da drin?"

# game/events/max.rpy:611
translate german delivery2_0ba1be34:

    # Max_00 "Да, то что нужно. Спасибо!"
    Max_00 "Ja, das ist genau das, was wir brauchen. Danke schön!"

# game/events/max.rpy:621
translate german delivery2_885c0cfc:
    ...
    Max_02 "{m}Ich habe es! Jetzt muss ich es Alice geben, und dann habe ich vielleicht Glück, wenn sie gerade ihren Blog schreibt. Zu der Zeit ist sie schon in Unterwäsche, und wenn sie die Klamotten bekommt, kann sie sich genauso gut vor mir umziehen...{/m}"

# game/events/max.rpy:623
translate german delivery2_1f5e97ce:
    ...
    Max_10 "{m}Ich hab's! Nur ist es zu spät... Eric hat schon eins für Alice gekauft. Ich kann nur noch versuchen, es weiterzuverkaufen, dann kriege ich wenigstens die Hälfte des Preises zurück.{/m}"

# game/events/max.rpy:633
translate german BookRead_9562ffab:

    # Max_00 "Пришло время почитать что-то..." nointeract
    Max_00 "Es ist an der Zeit, etwas zu lesen..." nointeract

# game/events/max.rpy:643
translate german BookRead_manual_41be558e:
...
translate german BookRead_manual_0826f3fe:
...
translate german BookRead_manual_3605e1d8:
...
translate german BookRead_manual_1c08c83d:
...
translate german BookRead_manual_bd8ad388:
...
translate german BookRead_sex_ed_e2e2e4d9:
...
translate german BookRead_sex_ed_5dc0d1da:
...
translate german BookRead_sex_ed_cdf53c7a:
...
translate german BookRead_sex_ed_58528ae0:
...
translate german InstallCam_9d11ed16:
    ...
    Max_04 "{m}Natürlich passiert hier selten etwas. Aber wenn doch, dann ist es so... Ich denke, die Zuschauer werden diese Momente genießen...{/m}" nointeract

# game/events/max.rpy:778
translate german InstallCam_bc72cb94:
    ...
    Max_03 "{m}Jetzt verpasst man nichts mehr von der Action! Die Mädchen sehen sich gerne vor dem Spiegel an, und Mom und Eric, wie ich bemerkt habe, versuchen, keine Gelegenheit zum Ficken vor dem Spiegel zu verpassen... Mein Publikum wird das lieben!{/m}" nointeract

# game/events/max.rpy:784
translate german InstallCam_3a6027ee:
    ...
    Max_04 "{m}Natürlich ist es moralisch fragwürdig, eine Kamera im Badezimmer anzubringen. Es gibt allerdings bereits ein wandfüllendes Fenster. Also technisch gesehen habe ich nur dieses Fenster geöffnet...{/m}" nointeract

# game/events/max.rpy:790
translate german InstallCam_918d8b5b:
    ...
    Max_04 "{m}Ich weiß nicht, ob diese Kamera etwas taugt... Es ist so wenig los hier... Nun, dann soll es so sein. Jetzt, wo alles verkabelt ist...{/m}" nointeract

# game/events/max.rpy:797
translate german InstallCam_3a93939c:

    # Max_04 "{m}Вот теперь зрители смогут насладится всеми мокрыми и блестящими красотами, происходящими во дворе...{/m}" nointeract
    Max_04 "{m}Das Publikum wird sich nun an all den nassen und glänzenden Schönheiten im Hof erfreuen können...{/m}" nointeract

# game/events/max.rpy:803
translate german InstallCam_3426c2fd:
    ...
    Max_04 "{m}Der Hof... Solange die Sonne scheint, ist wahrscheinlich jemand hier. Ich denke, das wird den Zuschauern gefallen, die hoffen, die Mädchen beim Sonnenbaden zu erwischen...{/m}" nointeract

# game/events/max.rpy:806
translate german InstallCam_7711d18e:
...
# game/events/max.rpy:1002
translate german cheat_money_strateg_16b9bde6:
