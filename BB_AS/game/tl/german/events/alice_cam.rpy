...
translate german cam0_blog_with_Eric_2dbcbfe9:
    ...
    Max_09 "{m}Eric redet mit Alice über irgendwas, ausgedehnt, als ob es sein Zimmer wäre...{/m}"

# game/events/alice_cam.rpy:740
translate german cam0_blog_with_Eric_f539e64b:

    # Max_08 "{m}Ого! Да она при нём, похоже, переодеваться вздумала! Что сказать, Эрик умеет добиваться своего...{/m}"
    Max_08 "{m}Wow! Sie sieht aus, als würde sie sich vor seinen Augen umziehen! Was soll ich sagen, Eric weiß, wie er bekommt, was er will...{/m}"

# game/events/alice_cam.rpy:745
translate german cam0_blog_with_Eric_dcf61634:
    ...
    Max_01 "{m}Die nackte und schöne Alice! Ich habe Eric gesagt, dass er nicht gucken soll, außer dass er sicher durch seine Finger gucken wird... Ich hätte es sicherlich gewagt, so nah an eine nackte Alice zu gucken!{/m}"

# game/events/alice_cam.rpy:749
translate german cam0_blog_with_Eric_d27dde4d:
    ...
    Max_07 "{m}Ugh... Alice nimmt sich die Zeit, ihre üppigen Brüste unter ihrem Bodysuit zu verstecken! Hmmm, vielleicht hat sie ja bemerkt, dass Eric sowieso guckt und neckt ihn auf diese Weise! Sie hat offensichtlich keine Ahnung, dass sie auch mich neckt...{/m}"

# game/events/alice_cam.rpy:754
translate german cam0_blog_with_Eric_c1401911:

    # Max_09 "{m}Понятно всё с вами, Алиса села на шею Эрику, а он и рад. Эх, Алиса... надеюсь, ты знаешь, что делаешь...{/m}"
    Max_09 "{m}Ich sehe, was hier los ist... Alice denkt, sie kann Eric benutzen, aber sie spielt ihm direkt in die Hände! Oh, Alice... Ich hoffe, du weißt, was du tust...{/m}"

# game/events/alice_cam.rpy:783
translate german cam0_blog_with_Eric_4181192f:
    ...
    Max_08 "{m}Eric ist heute in Alice' Zimmer. Sieht aus, als wolle er ihr mit ihrem Blog helfen... Aber in Wirklichkeit will er nur einen guten Blick auf sie in ihrer Unterwäsche werfen, ich würde es tun...{/m}"
...
translate german strings:
    ...
    new "{i}Nimm die Kamera und geh zum Fenster von Alice{/i}"
    ...
    new "{i}Nimm die Kamera und geh auf den Balkon{/i}"
