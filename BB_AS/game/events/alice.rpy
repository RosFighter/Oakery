...
label alice_after_club:
    ...
    $ peeping['alice_bath'] = 1
    menu:
        Max_00 "Алиса только что вернулась из клуба и сразу забежала в ванную. Интересно, в каком она состоянии?"
        "{i}постучаться{/i}":
            if flags['alice.drink']:
                jump .knock
            menu:
                Alice "{b}Алиса:{/b} Кому там не спится? Я ванну набираю..."
                "Это я, Макс. Можно войти?":
        ...
        "{i}заглянуть со двора{/i}" if 'ladder' not in flags or flags['ladder'] < 2:
            scene Alice bath 01
            $ renpy.show('FG voyeur-bath-00'+mgg.dress)
            Max_00 "Ух! Повезло, что она меня не заметила... Кажется, только воду набирает. Но лучше уйти, а то если заметит, мне конец!"
            jump .end
    ...
    label .knock:
        ...
        # show Alice bach-after-club
        Alice_05 "А, Макс... Не спится? Чего хотел?"
        Max_00 "Да... Я вот... Умыться бы перед сном! Да."
        Alice_04 "Ну, входи. Я собиралась ванну принять, но ещё вода набирается..."
        Max_00 "Как в клубе повеселилась?"
        Alice_01 "Ты знаешь, очень... очень хорошо. Я обычно не пью, но в этот раз что-то потянуло и... всё прошло просто чудесно! А у тебя как дела?"
        Max_00 "Ого. Тебе и правда интересно?"
        Alice_05 "Конечно! Ты же мой брат. Ты извини, если я с тобой бываю груба. Это просто защитная реакция..."
        Max_00 "Защитная реакция?"
        ...
        Max_00 "Э... Ты точно в порядке?"
        ### здесь ставим флаг разговора в ванной, продвижение возможности тусовщица
        menu:
            Alice_05 "Ага. И ты, я вижу, тоже... Какой же он у тебя большой..."
            "У тебя... Очень красивая грудь...":
                ...
                Max_00 "А ты не хочешь мне помочь?"
