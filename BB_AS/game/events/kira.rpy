...
label kira_bath:
    ...
    label .mass_bath:
        ...
        if _in_replay or not wcv['catch.Kira'].enabled:
            $ __ch_catch = 0
...
label kira_night_tv:
    ...
    label .tv_sex1:
        ...
        menu:
            ...
            "{i}трахнуть тётю Киру{/i} (миссионерская поза)" if __naked:
                jump .missionary

            "{i}снять шорты и трахнуть тётю Киру{/i} (миссионерская поза)" if not __naked:
                jump .missionary
