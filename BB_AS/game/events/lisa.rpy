...
label lisa_shower:
    ...
    label .ladder:
        ...
        Max_00 "Ладно, пора уходить, а то еще заметит кто-нибудь..."
        jump .end_peeping
...
label lisa_dressed_school:
    ...
    label .look_window:
        ...
        if __ran1 == "01":
            $ chars["lisa"].dress_inf = "02h"
        elif __ran1 == "02":
            $ chars["lisa"].dress_inf = "02e"
        elif __ran1 == "03":
            $ chars["lisa"].dress_inf = "02b"
        else:
    ...
    if peeping["lisa_dressed"] != 0:
        ...
        label .look_window:
            ...
            if __ran1 == "03":
                ...
                $ chars["lisa"].dress_inf = "02i"
            else:
                $ chars["lisa"].dress_inf = "02g"
