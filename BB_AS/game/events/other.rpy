...
label back_shoping:
    ...
    if EventsByTime["back_shoping"].stage == 1:
        ...
        Max_00 "А что с Лизой? Купальник купили?"
        menu:
            ...
            "Слишком дорогой это сколько?":
                ...
                Max_00 "Ясно. А насколько открытыми были остальные?"
            "Насколько открытые?":
                pass
        ...
        Ann_75 "Привет, Макс! Мы вернулись..."
        Max_00 "Рассказывайте, что купили?"
        if possibility["Swimsuit"].stage_number == 2:
            ...
            Max_00 "Конечно, рад... Что-то ещё хорошее купили?"
        else:
