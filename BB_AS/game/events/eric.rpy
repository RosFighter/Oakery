    ...
    label .practice_1:  # первая практика
        ...
        menu:
            ...
            "{i}прервать Лизу и Эрика{/i}":
                ...
                $ infl[lisa].sub_e(30)
                $ poss['seduction'].open(28)    # прописываем: Макс помешал Эрику и Лизе во время практических занятий
                return
...
label start_eric_wallet:
    ...
    $ flags.eric_wallet = 2
    $ poss['alpha'].open(4)     # Эрик обвинил Макса в воровстве
    $ spent_time = 30
    jump Waiting


label eric_kira_night_swim:
    #pool-n-01a + pool-n-01a-eric&kira-01
    scene BG char Eric pool-n-01a
    show Eric pool-n 01
    menu:
        Eric_13 "Ты зачем подкрадываешься, Макс?! Ночь на дворе. Заканчивай шататься и спать иди. Не мешай нам отдыхать."
        "{i}уйти{/i}":
            pass
    $ current_room = house[0]
    jump Sleep
