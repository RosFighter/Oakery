...
label liza_hand_mass:
    ...
    menu:
        ...
        "{i}закончить массаж{/i}":
            pass
    if all([not _in_replay, dcv['lisa_mentor'].done, poss['seduction'].stn>7, talk_var['kiss_lessons']>3, talk_var['kiss_massage']==0]):
    ...
    elif all([not _in_replay, dcv['lisa_mentor'].done, poss['seduction'].stn>7, talk_var['kiss_lessons']>3, talk_var['kiss_massage']>0]):
...
# label lisa_gift_book_sed:
#     # стартовая фраза "Ты же любишь читать?"
#     menu:
#         Lisa_02 "Ага, бывает иногда..."
#         "У меня для тебя особая книжка...":
#             pass
#         "Понятно. Я просто так спросил...":
#             # хз, зачем нужен этот вариант
#             jump Waiting
#
#     Lisa_01 "Ого. Подарок для меня, да ещё книжка! Интересная, хоть?"
#     Max_00 "Ну, зависит от настроения..."
#     menu:
...
#     Max_00 "Вполне. Считай это частью моей программы!"
#     Lisa_02 "Что, своих знаний маловато, решил воспользоваться сторонней помощью?"
#     Max_00 "Так ты берёшь книгу или нет?"
#     menu:
