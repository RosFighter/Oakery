...
label Lisa_sorry:
    ...
    $ peeping['lisa_shower'] = 0
    $ sorry_gifts['lisa'].owe = True
    $ sorry_gifts['lisa'].left = 2 if GetWeekday(day) == 6 else 1
    $ sorry_gifts['lisa'].days.insert(0, day)
    $ spent_time += 10
    jump Waiting
...
label conversation_after_dinner(var=0):
    ...
    $ renpy.show("Lisa talk-terrace 01"+chars["lisa"].dress)
    $ renpy.show("Max talk-terrace 01"+mgg.dress)
    Lisa_00 "Макс, подожди минутку..."
    Max_00 "Да, Лиза, что такое?"

    if var == 1:
        # Макс совсем не помогал Лизе делать уроки
        $ renpy.show("Lisa talk-terrace 02"+chars["lisa"].dress)
        menu:
        ...
        $ renpy.show("Lisa talk-terrace 03"+chars["lisa"].dress)
        ...
        # Макс безвозмездно помогал Лизе делать уроки, но перестал
        $ renpy.show("Lisa talk-terrace 02"+chars["lisa"].dress)
        ...
        # Макс помогал Лизе делать уроки за услуги, но перестал
        $ renpy.show("Lisa talk-terrace 02"+chars["lisa"].dress)
...
label lisa_sorry_gifts:
    ...
    label .bad: ## ненавистное
        ...
        if len(sorry_gifts['lisa'].give) == 0:  # ненавситное в первый раз
    ...
    label .end:
        # if len(sorry_gifts['lisa'].days) and day - sorry_gifts['lisa'].days[0] < 4:
        #     Lisa_00 "Кстати, Макс, тебе не кажется, что ты зачастил? Я конечно люблю сладкое, но если будешь подглядывать за мной так часто, в следующий раз я сразу скажу маме..."
        $ spent_time += 10
        jump Waiting
