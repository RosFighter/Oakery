...
label Lisa_HomeWork:
    ...
    label .next_foot_mass:
        ...
        menu:
            ...
            "{i}закончить массаж{/i}":
                pass
            "Я и плечи помассировать могу, если хочешь? {color=[_ch2.col]}(Убеждение. Шанс: [_ch2.vis]){/color}" if len(online_cources)>1 and online_cources[1].cources[1].less and talk_var['lisa.handmass']>1:
                jump .shoulders
        scene BG char Lisa lessons-help-00
        $ renpy.show("FG lessons-help-"+pose3_1)
        $ renpy.show("Lisa lessons-help "+pose3_1+lisa.dress)
