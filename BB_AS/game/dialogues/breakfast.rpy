    ...
    menu .next:
        ...
        "Нормальный мужик" if GetRelMax('eric')[0] > 3:
            menu:
                ...
                "А ещё он маме предложение сделал...":
...
label breakfast_after_punishment:
    ...
    elif all([GetWeekday(day)==2, dcv['kiratalk'].stage in [6, 7], talk_var['breakfast']==18, talk_var['dinner']==17]):
