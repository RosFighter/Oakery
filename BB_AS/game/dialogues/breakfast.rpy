...
label breakfast_2:
    ...
    $ renpy.show("Ann punish-morning 00"+characters["ann"].dress)
    menu:
    ...
    $ renpy.show("Ann punish-morning 01"+characters["ann"].dress)
    $ SetPossStage("sg", 0)
    menu:
        ...
        "{i}Наблюдать{/i}":
            ...
            $ renpy.show("Ann punish-morning lisa-01"+characters["ann"].dress)
            pause 0.5
            $ renpy.show("Ann punish-morning lisa-02"+characters["ann"].dress)
            ...
            $ renpy.show("Ann punish-morning 00"+characters["ann"].dress)
            menu:
                Ann_00 "Вот и хорошо, что поняла. Теперь иди садись. Прошу прощения, что пришлось прервать завтрак, но иначе нельзя. И да, если узнаю, что кто-то мне врёт, тот получит гораздо сильнее. Больше всего ненавижу ложь. Всё ясно?"
                "Ясно...":
                    pass
