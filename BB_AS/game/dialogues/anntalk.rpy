...
label ann_about_ann_secret1:    # Попытка разузнать у мамы её секрет
...
label ann_yoga_with_max0:       # первая совместная йога
    ...
    #если Анна заметила, что Макс подглядывает за ней в душе перед йогой и убеждение не удалось (уроков для Макса у Анны и Эрика не было)
    if (punreason[3] or punreason[2]) and flags.voy_stage < 4:
        Ann_17 "Макс, ты мне всё настроение испортил своим подглядыванием! Даже не думай отвлекать меня!"
        Max_11 "Ладно, понял..."
        jump Waiting

    #если Анна заметила, что Макс подглядывает за ней в душе перед йогой и убеждение не удалось (у Макса был хотя бы один урок у Анны и Эрика)
    if (punreason[3] or punreason[2]) and flags.voy_stage > 3:
        Ann_17 "Макс, ты мне всё настроение испортил своим подглядыванием! Даже не думай отвлекать меня!"
