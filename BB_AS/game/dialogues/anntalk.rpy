...
label ann_talk_tv:
    ...
    label .first_movie:
        ## "Что смотришь?"
        menu:
            Ann_00 "Да так, всякую ерунду. Хотела какой-нибудь фильм посмотреть. Садись рядом, если тоже делать нечего..."
            "Конечно! Что смотреть будем?":
                $ talk_var["ann_movie"]  += 1
                $ renpy.show("Max tv-closer "+pose3_1+mgg.dress)
            "В другой раз...":
                Ann_05 "Ну, как хочешь!"
                Max_00 "Не буду тебе мешать..."
                jump Waiting
    menu:
        Ann_14 "Я не знаю. Мне вот подруга посоветовала фильм с Томом Крузом и Николь Кидман, называется \"С широко закрытыми глазами\". Смотрел?"
        ...
        "Да, слышал кое-что о нём...":
            menu:
                Ann_00 "Да? И что ты о нём слышал? Хороший фильм? Стоит смотреть?"
                "Да, отзывы отличные":
                    menu:
    ...
    label .start:
        ...
        show Ann tv-watch 01a
        $ renpy.show('Max tv-watch 01'+mgg.dress)
    Max_00 "{i}Интересно, мама хотя бы подозревает, что это эротика?... Посмотрим...{/i}"
    show tv ews 02 at tv_screen
    Ann_12 "Ой, кажется, я не посмотрела какой возрастной рейтинг у фильма..."
    Max_00 "Да всё в порядке!"
    show tv ews 03 at tv_screen
    Ann_14 "Да уж... В порядке. Ну, если ты стесняешься, можешь закрыть глаза..."
    Max_00 "Я уже взрослый! И не такое видел!"
    show tv ews 04 at tv_screen
    Ann_01 "Да ты что? И где, интересно мне знать? Я когда подключала интернет, выбрала самый безопасный вариант, чтобы оградить вас от такого... Так где ты что там видел?"
    Max_00 "Да это не важно. В любом случае, это же популярный фильм с известными актёрами, что тут такого может быть..."
    show tv ews 05 at tv_screen
    Ann_00 "Да, ты прав. Действительно, что... Макс! Чем дальше, тем больше я уверена, что этот фильм не для тебя..."
    Max_00 "Ну сама подумай, стали бы Том Круз и Николь Кидман сниматься в эротике?"
    show tv ews 06 at tv_screen
    menu:
        Ann_01 "Надеюсь, ты закрыл глаза, потому-что это уже слишком!"
    ...
    Max_00 "Ты до 30 лет будешь меня оберегать от такого?"
    show tv ews 08 at tv_screen
    Ann_01 "Ты знаешь, может быть... Но да, ты прав. Фильм и правда хороший оказался. Хотя и не для детей, однозначно..."
    Max_00 "Мне тоже понравилось!"
    scene BG lounge-tv-01
