    ...
    if warning < 2 and newpunishment == 0:
        ...
        if RandomChance(_chance):
            ...
            if mgg.dress == "a":
                ...
                $ _text = _("шорты")
            menu:
                Ann_19 "[failed!t]Вот так просто? \"Я не виноват\" и всё забудем? Нет, Макс, со мной эти шуточки не прокатят. Давай, снимай [_text!tq] и ложись на мои колени. Надеюсь, ты сегодня в трусах..."
                "{i}снять штаны{/i}":
                    pass
