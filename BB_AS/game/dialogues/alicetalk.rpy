...
label talkblog1:
    ...
    menu:
        ...
        "Нет, хотел просто больше узнать":
            menu:
                Alice_01 "Что, даже не начнёшь подкалывать? И что ты хотел узнать?" # Alice_02
    ...
    label .together:
        ...
        menu:
            ...
            "Конечно! Будет у нас семейный бизнес!":
                menu:
                    Alice_01 "Семейный бизнес? На моём блоге? Может ещё и сам вести будешь?" #Alice_07
    ...
    label .findout:
        $ talk_var["blog"] = 2
        menu:
            Alice_01 "Ну, давай. Сомневаюсь, конечно, что это не пустая болтовня, но вдруг... Удиви меня!" #Alice_07
            "Постараюсь...":
