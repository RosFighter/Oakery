...
label set_alice_schedule:
    ...
    $ alice.add_schedule(
        ...
        Schedule((3, 0), '7:0', '7:59', 'sleep', "спит (утро)", 'house', 1, 'alice_sleep_morning', variable="shower_schedule in [0, 2]", enabletalk=False, glow=110),                         #
        ...
        Schedule((2, 5), '8:0', '8:59', 'shower', 'в душе с Кирой', 'house', 3, 'kira_alice_shower', variable="shower_schedule in [1, 2]", enabletalk=False, glow=140),                      #
        ...
        Schedule((3, 0), '8:0', '8:59', 'shower', 'одна в душе', 'house', 3, 'alice_shower', variable="shower_schedule == 2", enabletalk=False, glow=120),                              #

        Schedule((6,), '8:0', '8:59', 'shower', "принимает душ", 'house', 3, 'alice_shower', variable="'kira' not in chars", enabletalk=False, glow=120),
        Schedule((6,), '8:0', '8:59', 'shower', 'в душе с Кирой', 'house', 3, 'kira_alice_shower', variable="'kira' in chars", enabletalk=False, glow=140),     #
...
label set_ann_schedule:
    ...
    $ ann.add_schedule(
        ...
        Schedule((3, 6), '0:0', '5:59', 'None', 'у Эрика дома', variable="'eric' in chars and not flags.eric_banished"),
        Schedule((3, 6), '0:0', '5:59', 'sleep', "спит", 'house', 2, 'ann_sleep', variable="'eric' not in chars or flags.eric_banished", enabletalk=False, glow=105),
        Schedule((0,), '0:0', '0:59', 'None', 'у Эрика дома', variable="'eric' in chars and not flags.eric_banished"),
        Schedule((0,), '0:0', '0:59', 'sleep', "спит", 'house', 2, 'ann_sleep', variable="'eric' not in chars or flags.eric_banished", enabletalk=False, glow=105),
        Schedule((0,), '1:0', '1:59', 'None', 'у Эрика дома', variable="'eric' in chars and not flags.eric_banished"),
        Schedule((0,), '1:0', '1:59', 'sleep', "спит", 'house', 2, 'ann_sleep', variable="'eric' not in chars", enabletalk=False, glow=105),

        Schedule((0,), '1:0', '1:59', 'sleep', "спит", 'house', 2, 'ann_sleep', variable="flags.eric_banished and ann.dcv.drink.stage < 3", enabletalk=False, glow=105),    # Анна ещё не начала выпивать
        Schedule((0,), '1:0', '1:59', 'drink', "выпивает", 'house', 4, 's1_ann_drink', variable="flags.eric_banished and ann.dcv.drink.stage > 2", enabletalk=False, glow=105),

        Schedule((0,), '2:0', '5:59', 'None', 'у Эрика дома', variable="'eric' in chars and not flags.eric_banished"),
        Schedule((0,), '2:0', '5:59', 'sleep', "спит", 'house', 2, 'ann_sleep', variable="'eric' not in chars or flags.eric_banished", enabletalk=False, glow=105),
...
label set_eric_schedule:
    ...
    $ eric.add_schedule(
        ...
        Schedule((4,), '3:00', '3:59', 'fuck', 'с Кирой в бассейне', 'house', 6, 'eric_kira_night_swim', variable="wcv.catch_Kira.stage and not any([eric.daily.sweets, flags.eric_banished, GetRelMax('eric')[0] > 0])", enabletalk=False, glow=140),
        Schedule((4,), '3:00', '3:59', 'sleep2', 'спит с Анной', 'house', 2, 'eric_ann_sleep', variable="all([wcv.catch_Kira.stage, not flags.eric_banished, any([eric.daily.sweets, GetRelMax('eric')[0] > 0])])", enabletalk=False, glow=110),
        ...
        Schedule((1, ), '20:00', '20:59', 'rest', 'в Аниной комнате', 'house', 2, 'eric_resting', variable="not flags.eric_banished"),
        Schedule((1, ), '20:00', '20:59', 'None', variable="flags.eric_banished"),
...
label set_kira_schedule:
    ...
    $ kira.add_schedule(
        ...
        Schedule((1, 4, 6), '6:00', '7:59', 'sleep', 'спит в гостиной (утро)', 'house', 4, 'kira_sleep_morning', enabletalk=False, glow=115),
        Schedule((0, 2, 3, 5), '6:00', '6:59', 'sleep', 'спит в гостиной (утро)', 'house', 4, 'kira_sleep_morning', enabletalk=False, glow=115),

        Schedule((2, 5), '7:00', '7:59', 'sleep', 'спит в гостиной (утро)', 'house', 4, 'kira_sleep_morning', variable="shower_schedule in [1, 2]", enabletalk=False, glow=115),     #
        ...
        Schedule((0, 3), '7:00', '7:59', 'sleep', 'спит в гостиной (утро)', 'house', 4, 'kira_sleep_morning', variable="shower_schedule < 2", enabletalk=False, glow=115),
        Schedule((3, 0), '7:00', '7:59', 'shower', 'в душе с Лизой', 'house', 3, 'kira_lisa_shower', variable="shower_schedule == 2", enabletalk=False, glow=135),              #
        ...
        Schedule((2, 5), '8:00', '8:59', 'shower', 'в душе с Алисой', 'house', 3, 'kira_alice_shower', variable="shower_schedule in [1, 2]", enabletalk=False, glow=140),            #
        ...
        Schedule((3, 0), '8:00', '8:59', 'swim', 'в бассейне', 'house', 6, 'kira_swim', variable="shower_schedule == 2", enabletalk=False, glow=105),                            #
...
label set_lisa_schedule:
    ...
    $ lisa.add_schedule(
        ...
        Schedule((0, 3), '7:0', '7:59', 'shower', 'в душе с Кирой', 'house', 3, 'kira_lisa_shower', variable="shower_schedule == 2", enabletalk=False, glow=135),                      #
        ...
        Schedule((2, 5), '7:00', '7:59', 'shower', 'одна в душе', 'house', 3, 'lisa_shower', variable="shower_schedule in [1, 2]", enabletalk=False, glow=120),                              #

        Schedule((1, 2, 4, 5, 6), '8:0', '8:59', 'read', "читает", 'house', 0, 'lisa_read', talklabel='lisa_read_closer', glow=105),

        Schedule((0, 3), '8:0', '8:59', 'read', "читает", 'house', 0, 'lisa_read', variable="shower_schedule in [0, 2]", talklabel='lisa_read_closer', glow=105),                             #
        ...
        Schedule((0, 1, 2, 3, 4, 5, 6), '19:0', '19:59', 'dinner', "семейный ужин", 'house', 5, 'dinner', enabletalk=False, glow=105),
        Schedule((0, 1, 2, 3, 4, 5, 6), '20:00', '20:59', 'dishes', "моет посуду", 'house', 4, 'lisa_dishes', variable='not dishes_washed', talklabel='lisa_dishes_closer'),
        Schedule((0, 1, 2, 3, 4, 5, 6), '20:00', '20:59', 'phone', "лежит с телефоном", 'house', 0, 'lisa_phone', variable='dishes_washed', talklabel='lisa_phone_closer', glow=105),
        Schedule((0, 1, 2, 3, 4, 5, 6), '21:00', '21:59', 'phone', "лежит с телефоном", 'house', 0, 'lisa_phone', talklabel='lisa_phone_closer', glow=105),
