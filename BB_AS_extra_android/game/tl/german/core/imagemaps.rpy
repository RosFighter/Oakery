...
translate german strings:
    ...
    new "{i}ihre Unterschenkel massieren{/i}"
    ...
    new "{i}ihre Schultern massieren{/i}"

    # game/core/imagemaps.rpy:82
    old "{i}массировать спину{/i}"
    new "{i}ihren Rücken massieren{/i}"
