...
translate english olivia_lisa_tv_3427be4e:

    # Max_07 "{i}( Девчонки смотрят какой-то сериал, а я бы лучше на них посмотрел... Вот только обещал не мешать... ){/i}" nointeract
    Max_07 "{i}( The girls are watching some soap opera. I'd rather watch them... But I promised not to interfere... ){/i}" nointeract

# game/events/olivia.rpy:39
translate english olivia_lisa_tv_c7fb90a4:
    ...
    Max_10 "[risky!t]{i}( No, it's too dangerous to spy on them! They might see me at any moment... And that would only make it worse for me! ){/i}" nointeract

# game/events/olivia.rpy:49
translate english olivia_lisa_tv_b0f8caff:
    ...
    Max_04 "{i}( Beautiful! Sitting on the couch with them would be much more interesting... I could look at them with one eye and at the screen with the other. Eh, I'd better not linger here, they might notice me at any moment... ){/i}"

# game/events/olivia.rpy:51
translate english olivia_lisa_tv_cbe54de6:
    ...
    Max_04 "{i}( Beautiful! Sitting on the couch with them would be much more interesting... I could look at them with one eye and at the screen with the other. Eh, I'd better not linger here, they might notice me at any moment... ){/i}" nointeract

# game/events/olivia.rpy:55
translate english olivia_lisa_tv_b032e183:
    ...
    Max_09 "{i}( So how do I get on the couch with them? I need to get Lisa more acclimated to my appearance, but how? Maybe if I let her catch me spying on her in the shower, we can negotiate something? ){/i}" nointeract

# game/events/olivia.rpy:58
translate english olivia_lisa_tv_4c7a5b02:
    ...
    Max_09 "{i}( So how do I get on the couch with them? I need to get Lisa more acclimated to my appearance, but how? Maybe I should let her catch me spying on her in the shower again? ){/i}" nointeract

# game/events/olivia.rpy:156
translate english olivia_night_visit_c0291a99:

    # Olivia_01 "Привет, Макс. А вот и я! Дома никого?"
    Olivia_01 "Hey, Max. Here I am! Is anyone else home?"

# game/events/olivia.rpy:157
translate english olivia_night_visit_04f7e51a:
...
translate english olivia_night_visit_b6a957f2:
...
translate english olivia_night_visit_3f7b101a:

    # Lisa_00 "Я тоже рада поваляться вместе с вами хоть один поздний вечерок." nointeract
    Lisa_00 "I love relaxing with you too!" nointeract
