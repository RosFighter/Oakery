...
translate english gift_black_lingerie_2b4ecf90:
    ...
    Max_09 "{i}( I want to see this! Maybe I can quickly run and look out the window? She might notice... Or I can run back to my room and check the camera? But by the time I can get to my laptop she might already be changed... Ah, here I come! ){/i}"
