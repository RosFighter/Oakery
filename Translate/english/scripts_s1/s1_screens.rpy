...
translate english strings:
    ...
    new "Use the cheat menu with caution - it can lead to errors in the passage."
    ...
    new "Part of the cheats will be accessed after you have made some progress to minimize the consequences of tampering with game variables."

    # game/scripts_s1/s1_screens.rpy:87
    old "Невозможно до открытия доступа к банку (открывается на 9 день)"
    new "Unable to access the bank (opens on day 9)"

    # game/scripts_s1/s1_screens.rpy:89
    old "Доступно один раз в день"
    new "Available once a day"
    ...
    new "You must take the first lesson of the online course \"Communication\""

    # game/scripts_s1/s1_screens.rpy:182
    old "Пропустить дни до:"
    new "Skip the days before:"
    ...
    new "Only available after Kira arrives"
