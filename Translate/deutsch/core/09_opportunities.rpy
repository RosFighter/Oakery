...
translate deutsch strings:
    ...
    new "Mit Erics Ankunft wurde es unerwartet schlimm für mich... Zuerst drohte er mir an, mich in ein Militärlager zu schicken. Er meinte, es wäre nötig, um einen Mann aus mir zu machen...\n\nIch bin schon ein Mann! Danach hat er meine Mutter davon überzeugt, dass wir auf eine andere Art und Weise bestraft werden sollten. Ich meine, ich weiß nicht, was gut ist, aber es ist... Also, ab nächster Woche werden wir voreinander bestraft... nackt! Das ist so peinlich!\n\nIch meine, ich weiß, es würde Spaß machen, die Brüste meiner Schwestern zu sehen, aber ich könnte auch vor allen Leuten ausgepeitscht werden. Ich meine, das würde meine Autorität wirklich untergraben. Erst diese blöde Militärlager-Idee, und jetzt das... Ich muss etwas dagegen Eric unternehmen!"
