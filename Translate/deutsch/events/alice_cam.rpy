...
translate deutsch cam0_alice_sleep_night_f2d9a8b1:
...
translate deutsch cam0_alice_sleep_night_5d7e1834:
...
translate deutsch cam0_alice_sleep_night_7ea3366c:
...
translate deutsch cam0_alice_sleep_night_bd2d0d90:
...
translate deutsch cam0_alice_sleep_night_5eb0479b:
...
translate deutsch cam0_alice_sleep_night_4b7e896c:
...
translate deutsch cam0_alice_sleep_night_64517693:
...
translate deutsch cam0_alice_sleep_night_22b77a79:
...
translate deutsch cam0_alice_sleep_night_ba6907da:
...
translate deutsch cam0_alice_sleep_night_5b3adf24:
...
translate deutsch cam0_alice_sleep_night_e319aa8d:
...
translate deutsch cam0_alice_sleep_night_badc9d8f:
...
translate deutsch cam0_alice_sleep_night_1d708372:
...
translate deutsch cam0_alice_sleep_night_ecdbc7a2:
...
translate deutsch cam0_alice_sleep_night_902c46ec:
...
translate deutsch cam0_alice_sleep_night_6dc7005e:
...
translate deutsch cam0_alice_sleep_night_2795e9eb:

    # Max_01 "Алиса сейчас спит..."
    Max_01 "Alice schläft."

# game/events/alice_cam.rpy:110
translate deutsch cam0_alice_sleep_morning_e96b98f3:
...
translate deutsch cam0_alice_sleep_morning_902c46ec:

    # Max_04 "Алиса сейчас спит... совсем голенькая и прекрасная..."
    Max_04 "Alice ist eingeschlafen... Ganz nackt und schön..."

# game/events/alice_cam.rpy:114
translate deutsch cam0_alice_sleep_morning_8db64cb6:
...
translate deutsch cam0_alice_sleep_morning_9186f10b:

    # Max_01 "Алиса ещё спит..."
    Max_01 "Alice schläft noch..."

# game/events/alice_cam.rpy:125
translate deutsch cam0_alice_shower_ce893c17:
...
translate deutsch cam0_alice_shower_d8fc5c8e:
...
translate deutsch cam1_alice_shower_ce893c17:
...
translate deutsch cam0_alice_lisa_shower_3c0684d8:
...
translate deutsch cam0_alice_lisa_shower_7316172d:
...
translate deutsch cam0_alice_lisa_shower_f7e1d741:
...
translate deutsch cam0_alice_lisa_shower_1dc7f6ff:
...
translate deutsch cam0_alice_lisa_shower_ff4d64ec:
...
translate deutsch cam1_alice_lisa_shower_51c91303:
...
translate deutsch cam1_alice_lisa_shower_69b5e572:
...
translate deutsch cam1_alice_lisa_shower_77deb168:
...
translate deutsch cam0_alice_dressed_shop_4018efed:
...
translate deutsch cam0_alice_dressed_shop_c8aa5176:
...
translate deutsch cam0_alice_dressed_shop_9d360f84:
...
translate deutsch cam0_alice_dressed_shop_64a95c05:
...
translate deutsch cam0_alice_dressed_shop_dcef6691:
...
translate deutsch cam0_alice_dressed_shop_f1b3f435:
...
translate deutsch cam0_alice_dressed_friend_4018efed:

    # Max_09 "Ничего интересного я здесь уже не увижу, Алиса полностью оделась."
    Max_09 "Hier gibt es nichts Interessantes. Alice ist vollständig angezogen."

# game/events/alice_cam.rpy:385
translate deutsch cam0_alice_dressed_friend_bf45de39:
...
translate deutsch cam0_alice_dressed_friend_9d360f84:

    # Max_02 "О да! Сейчас она совсем голенькая..." nointeract
    Max_02 "Ja! Sie ist jetzt völlig ausgezogen..." nointeract

# game/events/alice_cam.rpy:408
translate deutsch cam0_alice_dressed_friend_356c787f:
...
translate deutsch cam0_alice_dressed_friend_d32fd8a9:
...
translate deutsch cam0_alice_dressed_friend_74b2c212:
...
translate deutsch cam0_alice_dressed_club_4018efed:

    # Max_09 "Ничего интересного я здесь уже не увижу, Алиса полностью оделась."
    Max_09 "Hier gibt es nichts Interessantes. Alice ist vollständig angezogen."

# game/events/alice_cam.rpy:437
translate deutsch cam0_alice_dressed_club_cc04128a:
...
translate deutsch cam0_alice_dressed_club_9d360f84:

    # Max_02 "О да! Сейчас она совсем голенькая..." nointeract
    Max_02 "Ja! Sie ist jetzt völlig ausgezogen..." nointeract

# game/events/alice_cam.rpy:459
translate deutsch cam0_alice_dressed_club_356c787f:

    # Max_01 "Трусики хорошо смотрятся на её попке. Вот только быть их на ней не должно... Считай, сестрёнка, ты попала!"
    Max_01 "So schön dieses Höschen auch ist, sie sollte es nicht tragen. Du kriegst Ärger, Schwesterherz!"

# game/events/alice_cam.rpy:463
translate deutsch cam0_alice_dressed_club_08a1f2c8:
...
translate deutsch cam0_alice_dressed_club_90be932b:
...
translate deutsch cam0_alice_rest_morning_57385ee4:
...
translate deutsch cam0_alice_dishes_b656e8e4:
...
translate deutsch cam0_alice_read_2a1ac283:
...
translate deutsch cam0_alice_read_ad8735f5:
...
translate deutsch cam0_alice_smoke_8754cb82:
...
translate deutsch cam0_alice_smoke_abc50ba4:
...
translate deutsch cam0_alice_sun_9e7392c6:
...
translate deutsch cam1_alice_sun_9e7392c6:

    # Max_01 "Загорающая Алиса радует глаза зрителей! Ну и мои заодно..."
    Max_01 "Das Sonnenbad mit Alice ist sicherlich ein erfreulicher Anblick für das Publikum! Und für mich natürlich auch."

# game/events/alice_cam.rpy:543
translate deutsch cam1_alice_sun_ce238a73:
...
translate deutsch cam0_alice_swim_39c0bef3:
...
translate deutsch cam0_alice_swim_06c19036:
...
translate deutsch cam1_alice_swim_47226f5e:
...
translate deutsch cam0_alice_cooking_dinner_6ebaaa99:
...
translate deutsch cam0_alice_rest_evening_74f01201:
...
translate deutsch cam0_alice_rest_evening_9247cd76:
...
translate deutsch cam0_alice_rest_evening_c01b3486:
...
# game/events/alice_cam.rpy:606
translate deutsch cam0_alice_rest_evening_262ced24:
...
translate deutsch cam0_alice_rest_evening_126cc7cc:
...
translate deutsch cam0_alice_rest_evening_8ad5ae2d:
...
# game/events/alice_cam.rpy:624
translate deutsch cam0_alice_tv_f2a9b64b:
...
translate deutsch cam0_alice_bath_e0114ed1:
...
# game/events/alice_cam.rpy:641
translate deutsch cam0_alice_bath_822a443e:
...
translate deutsch cam0_alice_bath_667774e8:
...
# game/events/alice_cam.rpy:654
translate deutsch cam1_alice_bath_ce893c17:

    # Max_09 "Алисы не видно через эту камеру... Может посмотреть через другую?"
    Max_09 "Ich kann Alice durch diese Kamera nicht sehen. Kann ich eine andere ausprobieren?"

# game/events/alice_cam.rpy:677
translate deutsch cam0_alice_blog_lingerie_75ff8725:
...
translate deutsch cam0_alice_blog_lingerie_470567da:
...
# game/events/alice_cam.rpy:688
translate deutsch cam0_alice_after_club_ce893c17:
...
translate deutsch cam0_alice_after_club_d8fc5c8e:

    # Max_09 "Алисы не видно через эту камеру..."
    Max_09 "Ich kann Alice durch diese Kamera nicht sehen..."

# game/events/alice_cam.rpy:697
translate deutsch cam0_alice_after_club_822a443e:

    # Max_04 "Не спеши, Алиса. Вытирайся помедленнее..."
    Max_04 "Lass dir Zeit, Alice. Trockne dich langsam ab..."

# game/events/alice_cam.rpy:703
translate deutsch cam0_alice_after_club_667774e8:

    # Max_05 "Это самый лучший ракурс, чтобы понаблюдать за тем, как Алиса принимает ванну! Заглядение..."
    Max_05 "Das ist der beste Winkel, um Alice beim Baden zuzuschauen! Ein schöner Anblick..."

# game/events/alice_cam.rpy:716
translate deutsch cam1_alice_after_club_2e382a0f:

    # Max_01 "Алиса вернулась из клуба."
    Max_01 "Alice ist aus dem Club zurück."

# game/events/alice_cam.rpy:721
translate deutsch cam1_alice_after_club_ce893c17:

    # Max_09 "Алисы не видно через эту камеру... Может посмотреть через другую?"
    Max_09 "Ich kann Alice durch diese Kamera nicht sehen. Kann ich eine andere ausprobieren?"

# game/events/alice_cam.rpy:734
translate deutsch cam0_blog_with_Eric_1210ca0b:

    # Max_09 "{i}( Эрик о чём-то разговаривает с Алисой. И развалился так, как будто это его комната... ){/i}"
    Max_09 "{i}( Eric redet mit Alice über irgendwas, ausgedehnt, als ob es sein Zimmer wäre... ){/i}"

# game/events/alice_cam.rpy:738
translate deutsch cam0_blog_with_Eric_47a71eff:

    # Max_08 "{i}( Ого! Да она при нём, похоже, переодеваться вздумала! Что сказать, Эрик умеет добиваться своего... ){/i}"
    Max_08 "{i}( Wow! Sie sieht aus, als würde sie sich vor seinen Augen umziehen! Was soll ich sagen, Eric weiß, wie er bekommt, was er will... ){/i}"

# game/events/alice_cam.rpy:743
translate deutsch cam0_blog_with_Eric_9a973c1d:
    ...
    Max_01 "{i}( Die nackte und schöne Alice! Ich habe Eric gesagt, dass er nicht gucken soll, außer dass er sicher durch seine Finger gucken wird... Ich hätte es sicherlich gewagt, so nah an eine nackte Alice zu gucken! ){/i}"

# game/events/alice_cam.rpy:747
translate deutsch cam0_blog_with_Eric_18d8cc91:
    ...
    Max_07 "{i}( Ugh... Alice nimmt sich die Zeit, ihre üppigen Brüste unter ihrem Bodysuit zu verstecken! Hmmm, vielleicht hat sie ja bemerkt, dass Eric sowieso guckt und neckt ihn auf diese Weise! Sie hat offensichtlich keine Ahnung, dass sie auch mich neckt... ){/i}"

# game/events/alice_cam.rpy:752
translate deutsch cam0_blog_with_Eric_913dbbe7:

    # Max_09 "{i}( Понятно всё с вами, Алиса села на шею Эрику, а он и рад. Эх, Алиса... надеюсь, ты знаешь, что делаешь... ){/i}"
    Max_09 "{i}( Ich sehe, was hier los ist... Alice denkt, sie kann Eric benutzen, aber sie spielt ihm direkt in die Hände! Oh, Alice... Ich hoffe, du weißt, was du tust... ){/i}"

# game/events/alice_cam.rpy:779
translate deutsch cam0_blog_with_Eric_340b426d:
    ...
    Max_08 "{i}( Eric ist heute in Alice' Zimmer. Sieht aus, als wolle er ihr mit ihrem Blog helfen... Aber in Wirklichkeit will er nur einen guten Blick auf sie in ihrer Unterwäsche werfen, ich würde es tun... ){/i}"
...
translate deutsch strings:
    ...
    new "{i}Nimm die Kamera und geh zum Fenster von Alice {color=[_ch1.col]}(Glück. Chance: [_ch1.vis]){/color}{/i}"

    # game/events/alice_cam.rpy:72
    old "{i}Да и хрен с ним, пусть дрочит{/i}"
    new "{i}Scheiß drauf, lass ihn sich einen runterholen{/i}"

    # game/events/alice_cam.rpy:83
    old "{i}Взять фотоаппарат и пойти на балкон {color=[_ch1.col]}(Удача. Шанс: [_ch1.vis]){/color}{/i}"
    new "{i}Nimm die Kamera und geh auf den Balkon {color=[_ch1.col]}(Glück. Chance: [_ch1.vis]){/color}{/i}"
