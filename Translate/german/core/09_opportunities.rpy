...
translate german strings:
    ...
    new "Dieser Scheißkerl Eric hat mich beschuldigt, seine Brieftasche mit Geld gestohlen zu haben! Und angeblich habe ich mit diesem gestohlenen Geld alle Geschenke für meine Familie gekauft. Er gab mir eine Woche Zeit, um es ihm zurückzuzahlen, sonst würde ich in ein Militärlager geschickt werden. Es ist eine Schande, dass sie Eric \"glauben\" und nicht mir. Eric hat auch klar gemacht, dass ich das nicht ändern kann, also liegt es an mir, ihn zu belasten. Aber zuerst muss ich mit meinen Schwestern reden, um herauszufinden, wie sehr sie Eric vertrauen."
