...
define talks = {
    ...
    "lisa_swim"  : TalkTheme("lisa", _("А ты чего так загораешь?"), "talk_swim", "possibility['Swimsuit'].stn < 0 and GetPlan(plan_lisa, day, tm).name == 'sun'"),
...
define gifts = {
    ...
    "alice" : [
        ...
        # Gift("pajamas", _("У меня для тебя подарок {i}(Пижамка){/i}"), "gift_pajamas"),
        # Gift("", _(""), ""),
        ],
    "ann"   : [
