...
default schedule_lisa = [
    ...
    Schedule((0, 1, 2, 3, 4, 5, 6), "9:0", "9:59", _("семейный завтрак"), "house", 5, "breakfast", dress="casual2"),
    ...
    Schedule((0, 1, 2, 3, 4, 5, 6), "19:0", "19:59", _("семейный ужин"), "house", 5, "dinner", dress="casual"),
