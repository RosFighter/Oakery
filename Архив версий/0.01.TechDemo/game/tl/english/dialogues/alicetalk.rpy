...
translate english talkblog1_dfa2b1ae:

    # Alice_02 "Да у других таких же блогеров подсмотрела, конечно. Все так делают! Ну и сама в интернете разное читаю, изучаю..." nointeract
    Alice_02 "From another bloggers, of course. Everyone does that! And sometimes I try to find something new on the web..." nointeract
